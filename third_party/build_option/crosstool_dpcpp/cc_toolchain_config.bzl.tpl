...
def _impl(ctx):
        ...
        flag_sets = [
            flag_set(
                ...
                flag_groups = [
                    ...
                    flag_group(flags = ["-isystem"]),
                    flag_group(flags = ["%{DPCPP_ROOT_DIR}/lib/clang/13.0.0/include"]),
                    flag_group(flags = ["-isystem"]),
                    flag_group(flags = ["%{DPCPP_ROOT_DIR}/lib/clang/14.0.0/include"]),
                    flag_group(flags = ["-isystem"]),
                    flag_group(flags = ["%{DPCPP_ROOT_DIR}/lib/clang/15.0.0/include"]),
                    flag_group(flags = ["-isystem"]),
                    flag_group(flags = ["%{DPCPP_ROOT_DIR}/lib/clang/16.0.0/include"]),
                    flag_group(flags = ["-isystem"]),
                    flag_group(flags = ["%{DPCPP_ROOT_DIR}/compiler/include"]),
    ...
    sys_inc = [
        ...
        "%{DPCPP_ROOT_DIR}/lib/clang/16.0.0/include",
        "%{DPCPP_ROOT_DIR}/compiler/include",
        "%{DPCPP_RUNTIME_INC}",
