...
- `PyPI Install for GPU <install_for_gpu.html>`_
- `PyPI Install for CPU <experimental/install_for_cpu.html>`_
...
- `Install C/C++ Calling Interface from Source Build <experimental/install_for_cpp.md>`_

.. toctree::
   :hidden:

   install_for_gpu.md
   experimental/install_for_cpu.md
   experimental/install_for_gpu_conda.md
   how_to_build.md
   experimental/install_for_cpp.md