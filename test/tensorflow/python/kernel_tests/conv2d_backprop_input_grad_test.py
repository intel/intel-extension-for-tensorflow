...
COMPUTE_TYPE = [dtypes.float32, dtypes.double]

@test_util.run_all_in_native_and_block_format
class Conv2DBackpropInputGradTest(test.TestCase):
        ...
        for padding in [
          ...
          for stride in [1, 2]:
            ...
            err = gradient_checker.compute_gradient_error(
                ...
                output, in_shape)
            print("conv2d_backprop_input gradient err = %g " % err)
