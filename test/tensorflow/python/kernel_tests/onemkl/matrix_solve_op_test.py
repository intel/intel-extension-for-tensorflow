...
class MatrixSolveOpTest(test.TestCase):
  ...
  def _verifySolve(self, x, y, batch_dims=None):
    x = np.array([[-2.2251024, -8.184399 ], [-9.781952, -3.8718832]])
    y = np.array([[-2.4736712, 4.988739 ], [ 3.160378, -2.5613396]])
  ...
  # Maozhou: oneMKL will crash for invalid input, just ignore it on GPU
