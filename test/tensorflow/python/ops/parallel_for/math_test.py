...
class MathTest(PForTestCase, parameterized.TestCase):
  ...
  def test_binary_cwise_ops(self):
    ...
    default_equality = tf.Tensor._USE_EQUALITY
  ...
  # TODO(itex): commented this test as there is known acc issue in _OneDnnAddN
  # def test_addn(self):
  ...
  # TODO(itex): commented these test for BCast is not allowed in BatchMatMul now,
  # remove it after supporting Eigen fallback
