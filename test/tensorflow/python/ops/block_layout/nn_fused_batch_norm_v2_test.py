...
# ==============================================================================
"""Tests for fused_batch_norm_v2 related functionality in tensorflow.ops.nn."""
...
def fused_batch_norm_v2(
  ...
  y, running_mean, running_var, _, _ = gen_nn_ops.fused_batch_norm_v2(
      x,
      scale,
      offset,
      mean,
...
class BatchNormalizationV2Test(test.TestCase):
  ...
  def _test_grad_grad(self,
    ...
    with self.cached_session(use_gpu=use_gpu) as sess:
      ...
      if x_dtype != np.float16:
        ...
        y32, _, _ = array_ops.identity_n(fused_batch_norm_v2(
            x32,
            scale,
            offset,
            mean=pop_mean,
