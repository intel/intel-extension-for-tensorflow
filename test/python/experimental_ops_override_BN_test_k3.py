...
class BatchNormalizationTest(test_util.TensorFlowTestCase):
    ...
    def testForward(self):
        ...
        res_tf = []
        res_itex = []
        res_tf += self._testForwardPass((2, 3, 2), 2)
        res_tf += self._testForwardPass((2, 2, 2, 2), 1)
        res_tf += self._testForwardPass((2, 2, 2, 2), 2)
        res_tf += self._testForwardPass((2, 3, 4, 5), 2)
        itex.experimental_ops_override()
        res_itex += self._testForwardPass((2, 3, 2), 2)
        res_itex += self._testForwardPass((2, 2, 2, 2), 1)
        res_itex += self._testForwardPass((2, 2, 2, 2), 2)
        res_itex += self._testForwardPass((2, 3, 4, 5), 2)
