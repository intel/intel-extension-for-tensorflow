...
class DynamicStitchTestBase(object):
  ...
  def testScalar(self):
    # Maozhou: soft_placement is True by default, so it works on XPU
  ...
  def testSimpleOneDimensional(self):
    ...
    dtypes_to_test = [
        dtypes.float32, dtypes.qint8, dtypes.quint8, dtypes.qint32, dtypes.float64,
        dtypes.float16, dtypes.bfloat16, dtypes.complex64, dtypes.complex128
    ]
