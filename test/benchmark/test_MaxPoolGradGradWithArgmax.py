...
class MaxPoolGradGradWithArgmaxTest(test.TestCase):
    ...
    def _test_impl(self, dtype):
        ...
        flush_cache()
        _result = gen_nn_ops.max_pool_grad_grad_with_argmax(origin_input, grad, _argmax, ksize, strides, padding)

    @add_profiling
    @multi_run(ITERATION)
    def testMaxPoolGradGradWithArgmax(self):
