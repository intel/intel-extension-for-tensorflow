...
#ifndef ITEX_CORE_COMPILER_XLA_EXECUTION_OPTIONS_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_EXECUTION_OPTIONS_UTIL_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_EXECUTION_OPTIONS_UTIL_H_
