...
#ifndef ITEX_CORE_COMPILER_XLA_PROTOBUF_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_PROTOBUF_UTIL_H_
...
extern bool ProtobufEquals(const itex::protobuf::Message& m1,
...
class ProtobufEqualsWrapper {
 public:
  bool operator()(const itex::protobuf::Message& m1,
                  const itex::protobuf::Message& m2) const {
...
class ProtobufHashWrapper {
 public:
  size_t operator()(const itex::protobuf::Message& m) const {
...
#endif  // ITEX_CORE_COMPILER_XLA_PROTOBUF_UTIL_H_
