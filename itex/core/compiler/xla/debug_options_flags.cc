...
#include "itex/core/compiler/xla/debug_options_parsers.h"
#include "itex/core/compiler/xla/parse_flags_from_env.h"
...
static std::vector<itex::Flag>* flag_objects;
...
static void AllocateFlags() {
  ...
  flag_objects = new std::vector<itex::Flag>();
  ...
  flag_objects->push_back(itex::Flag(
  ...
  flag_objects->push_back(
      itex::Flag("xla_embed_ir_in_executable",
  ...
  flag_objects->push_back(
      itex::Flag("xla_cpu_use_xla_runtime",
  ...
  flag_objects->push_back(
      itex::Flag("xla_dump_hlo_as_proto",
  ...
  flag_objects->push_back(
      itex::Flag("xla_dump_hlo_as_html",
  ...
  flag_objects->push_back(itex::Flag(
      ...
      "by --xla_dump_to."));
  flag_objects->push_back(
      itex::Flag("xla_dump_compress_protos",
  ...
  flag_objects->push_back(
      itex::Flag("xla_gpu_force_conv_nchw",
  ...
  flag_objects->push_back(
      itex::Flag("xla_gpu_force_conv_nhwc",
  ...
  flag_objects->push_back(
      itex::Flag("xla_gpu_deterministic_ops",
  ...
  flag_objects->push_back(
      itex::Flag("xla_gpu_enable_cublaslt",
  ...
  flag_objects->push_back(
      itex::Flag("xla_dump_disable_metadata",
  ...
  flag_objects->push_back(
      itex::Flag("xla_gpu_normalize_layouts",
...
void AppendDebugOptionsFlags(std::vector<itex::Flag>* flag_list) {
  absl::call_once(flags_init, &AllocateFlags);
  flag_list->insert(flag_list->end(), flag_objects->begin(),
                    flag_objects->end());
}

itex_xla::DebugOptions GetDebugOptionsFromFlags() {
  absl::call_once(flags_init, &AllocateFlags);
  return *flag_values;
}
...
void ResetThreadLocalFuel() {
  ...
  thread_fuel = std::make_unique<
      absl::node_hash_map<std::string, std::atomic<int64_t>>>();
  ITEX_CHECK(initial_fuel != nullptr);
