...
#ifndef ITEX_CORE_COMPILER_XLA_SHAPE_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_SHAPE_UTIL_H_
...
class ShapeUtil {
 public:
  ...
  static bool DynamicArrayShapeIsCompatible(
  ...
  static bool DynamicShapeIsCompatible(const itex_xla::Shape& dynamic_shape,
                                       const itex_xla::Shape& bounded_shape);
...
#endif  // ITEX_CORE_COMPILER_XLA_SHAPE_UTIL_H_
