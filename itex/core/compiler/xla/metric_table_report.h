...
#ifndef ITEX_CORE_COMPILER_XLA_METRIC_TABLE_REPORT_H_
#define ITEX_CORE_COMPILER_XLA_METRIC_TABLE_REPORT_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_METRIC_TABLE_REPORT_H_
