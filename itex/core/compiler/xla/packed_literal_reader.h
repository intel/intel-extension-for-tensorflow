...
#ifndef ITEX_CORE_COMPILER_XLA_PACKED_LITERAL_READER_H_
#define ITEX_CORE_COMPILER_XLA_PACKED_LITERAL_READER_H_
...
class PackedLiteralReader {
 public:
  ...
  explicit PackedLiteralReader(itex::RandomAccessFile* file);
  ~PackedLiteralReader();
 ...
 private:
  itex::RandomAccessFile* file_;  // We own and close in our destructor
...
#endif  // ITEX_CORE_COMPILER_XLA_PACKED_LITERAL_READER_H_
