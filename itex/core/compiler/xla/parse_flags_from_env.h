...
#ifndef ITEX_CORE_COMPILER_XLA_PARSE_FLAGS_FROM_ENV_H_
#define ITEX_CORE_COMPILER_XLA_PARSE_FLAGS_FROM_ENV_H_
...
// Calls itex::Flags::Parse(argc, argv, flag_list) against any as yet
...
#endif  // ITEX_CORE_COMPILER_XLA_PARSE_FLAGS_FROM_ENV_H_
