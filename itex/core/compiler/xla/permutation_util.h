...
#ifndef ITEX_CORE_COMPILER_XLA_PERMUTATION_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_PERMUTATION_UTIL_H_
...
std::vector<typename Container::value_type> Permute(
  ...
  ITEX_CHECK_EQ(permutation.size(), data.size());
...
#endif  // ITEX_CORE_COMPILER_XLA_PERMUTATION_UTIL_H_
