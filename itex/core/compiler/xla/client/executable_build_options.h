...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_EXECUTABLE_BUILD_OPTIONS_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_EXECUTABLE_BUILD_OPTIONS_H_
...
#include "protos/compile_options.pb.h"
...
class ExecutableBuildOptions {
 public:
  ...
  const DeviceAssignment& device_assignment() const {
    ITEX_CHECK(device_assignment_.has_value());
  ...
  itex::thread::ThreadPool* compile_thread_pool() const {
    return compile_thread_pool_;
  }
  ExecutableBuildOptions& set_compile_thread_pool(
      itex::thread::ThreadPool* compile_thread_pool) {
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_EXECUTABLE_BUILD_OPTIONS_H_
