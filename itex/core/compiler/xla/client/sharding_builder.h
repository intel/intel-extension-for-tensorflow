...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_SHARDING_BUILDER_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_SHARDING_BUILDER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_SHARDING_BUILDER_H_
