...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_XLA_BUILDER_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_XLA_BUILDER_H_
...
#include "itex/core/compiler/xla/service/dynamic_parameter_binding.h"
...
// Arith operator overloads for the XlaOp type.
...
class XlaBuilder {
 ...
 private:
  ...
  XlaOp AllReduce(
      ...
      const absl::optional<bool> use_global_device_ids = std::nullopt);
  ...
  itex::SavedStackTrace first_error_backtrace_;
...
class XlaScopedShardingAssignment {
 public:
  XlaScopedShardingAssignment(itex_xla::XlaBuilder* builder,
 ...
 private:
  ...
  itex_xla::XlaBuilder* const builder_;
...
class XlaScopedFrontendAttributesAssignment {
 public:
  XlaScopedFrontendAttributesAssignment(itex_xla::XlaBuilder* builder,
...
class XlaScopedOpMetadataAssignment {
 public:
  XlaScopedOpMetadataAssignment(itex_xla::XlaBuilder* builder,
                                OpMetadata metadata)
      : builder_(builder) {
...
XlaOp ConstantR1(XlaBuilder* builder, const itex::core::Bitmap& values);
template <typename NativeT>
...
inline XlaOp ConstantR1(XlaBuilder* builder, const itex::core::Bitmap& values) {
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_XLA_BUILDER_H_
