...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_LIB_POOLING_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_LIB_POOLING_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_LIB_POOLING_H_
