...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_LIB_CONV_GRAD_SIZE_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_LIB_CONV_GRAD_SIZE_UTIL_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_LIB_CONV_GRAD_SIZE_UTIL_H_
