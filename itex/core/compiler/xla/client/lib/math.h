...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_LIB_MATH_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_LIB_MATH_H_
...
itex_xla::XlaOp MaybeConjugate(itex_xla::XlaOp x, bool conjugate);
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_LIB_MATH_H_
