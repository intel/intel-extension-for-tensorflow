...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_LIB_PRNG_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_LIB_PRNG_H_
...
RngOutput UniformIntDistribution(XlaOp key, XlaOp initial_state,
                                 ...
                                 XlaOp maxval, const itex_xla::Shape& shape);
...
itex_xla::XlaOp PhiloxIncreaseCounter(itex_xla::XlaOp counter,
                                      itex_xla::XlaOp delta);

}  // namespace itex_xla

#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_LIB_PRNG_H_
