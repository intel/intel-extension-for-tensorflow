...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_LIB_SELF_ADJOINT_EIG_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_LIB_SELF_ADJOINT_EIG_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_LIB_SELF_ADJOINT_EIG_H_
