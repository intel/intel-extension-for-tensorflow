...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_LIB_TRIDIAGONAL_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_LIB_TRIDIAGONAL_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_LIB_TRIDIAGONAL_H_
