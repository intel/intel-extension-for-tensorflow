...
#ifndef ITEX_CORE_COMPILER_XLA_CLIENT_LIB_MATRIX_H_
#define ITEX_CORE_COMPILER_XLA_CLIENT_LIB_MATRIX_H_
...
itex_xla::XlaOp BatchDot(
    itex_xla::XlaOp x, itex_xla::XlaOp y,
    itex_xla::PrecisionConfig::Precision precision =
        itex_xla::PrecisionConfig::DEFAULT,
    absl::optional<PrimitiveType> preferred_element_type = absl::nullopt);
itex_xla::XlaOp BatchDot(
    itex_xla::XlaOp x, bool transpose_x, itex_xla::XlaOp y, bool transpose_y,
    itex_xla::PrecisionConfig::Precision precision =
        itex_xla::PrecisionConfig::DEFAULT,
    absl::optional<PrimitiveType> preferred_element_type = absl::nullopt);
...
itex_xla::XlaOp Einsum(
    itex_xla::XlaOp x, itex_xla::XlaOp y, absl::string_view einsum_config,
    itex_xla::PrecisionConfig::Precision precision =
        itex_xla::PrecisionConfig::DEFAULT,
    absl::optional<PrimitiveType> preferred_element_type = absl::nullopt);
itex_xla::XlaOp Einsum(itex_xla::XlaOp x, absl::string_view einsum_config,
                       itex_xla::PrecisionConfig::Precision precision =
                           itex_xla::PrecisionConfig::DEFAULT);
...
//   output_config = {0, 2}
itex_xla::XlaOp Einsum(
    itex_xla::XlaOp x, absl::Span<const int64_t> x_config, itex_xla::XlaOp y,
...
itex_xla::XlaOp TransposeInMinorDims(itex_xla::XlaOp x);

// Transposes `x` in its minor dimensions if `transpose` is true, otherwise
// returns `x` unchanged.
itex_xla::XlaOp MaybeTransposeInMinorDims(itex_xla::XlaOp x, bool transpose);

}  // namespace itex_xla

#endif  // ITEX_CORE_COMPILER_XLA_CLIENT_LIB_MATRIX_H_
