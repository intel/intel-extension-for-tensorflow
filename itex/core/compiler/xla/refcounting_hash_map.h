...
#ifndef ITEX_CORE_COMPILER_XLA_REFCOUNTING_HASH_MAP_H_
#define ITEX_CORE_COMPILER_XLA_REFCOUNTING_HASH_MAP_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_REFCOUNTING_HASH_MAP_H_
