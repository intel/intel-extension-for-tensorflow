...
#ifndef ITEX_CORE_COMPILER_XLA_PJRT_PJRT_FUTURE_H_
#define ITEX_CORE_COMPILER_XLA_PJRT_PJRT_FUTURE_H_
...
class PjRtFuture {
 public:
  ...
  T Await() {
    ...
    ITEX_DCHECK(promise_ref_.IsConcrete());
    return *promise_ref_;
  }
  ...
  void OnReady(absl::AnyInvocable<void(T) &&> callback) {
    ...
    promise_ref_.AndThen([promise = promise_ref_.AsPtr(),
      ...
      ITEX_DCHECK(promise.IsConcrete());
...
#endif  // ITEX_CORE_COMPILER_XLA_PJRT_PJRT_FUTURE_H_
