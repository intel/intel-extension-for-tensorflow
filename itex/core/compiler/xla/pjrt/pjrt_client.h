...
#ifndef ITEX_CORE_COMPILER_XLA_PJRT_PJRT_CLIENT_H_
#define ITEX_CORE_COMPILER_XLA_PJRT_PJRT_CLIENT_H_
...
#include "itex/core/compiler/xla/pjrt/pjrt_executable.h"
#include "itex/core/compiler/xla/pjrt/pjrt_future.h"
...
inline PjRtPlatformId CpuId() {
  static const PjRtPlatformId kCpuId = itex::Fingerprint64(CpuName());
  return kCpuId;
}
inline PjRtPlatformId GpuId() {
  static const PjRtPlatformId kGpuId = itex::Fingerprint64(GpuName());
  return kGpuId;
}
inline PjRtPlatformId TpuId() {
  static const PjRtPlatformId kTpuId = itex::Fingerprint64(TpuName());
  return kTpuId;
}
inline PjRtPlatformId XpuId() {
  static const PjRtPlatformId kXpuId = itex::Fingerprint64(XpuName());
  return kXpuId;
}
...
#endif  // ITEX_CORE_COMPILER_XLA_PJRT_PJRT_CLIENT_H_
