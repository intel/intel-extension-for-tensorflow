...
#ifndef ITEX_CORE_COMPILER_XLA_PJRT_WORKER_THREAD_H_
#define ITEX_CORE_COMPILER_XLA_PJRT_WORKER_THREAD_H_
...
class WorkerThread {
 public:
  ...
  WorkerThread(itex::Env* env, const std::string& name);
 ...
 private:
  ...
  std::unique_ptr<itex::Thread> thread_;
};

}  // namespace itex_xla

#endif  // ITEX_CORE_COMPILER_XLA_PJRT_WORKER_THREAD_H_
