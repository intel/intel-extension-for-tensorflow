...
#ifndef ITEX_CORE_COMPILER_XLA_PJRT_LRU_CACHE_H_
#define ITEX_CORE_COMPILER_XLA_PJRT_LRU_CACHE_H_
 ...
 public:
  ...
  class LRUList {
   public:
    ...
    ~LRUList() {
      ITEX_CHECK(head_.next == &head_);
      ITEX_CHECK(head_.prev == &head_);
    }
...
#endif  // ITEX_CORE_COMPILER_XLA_PJRT_LRU_CACHE_H_
