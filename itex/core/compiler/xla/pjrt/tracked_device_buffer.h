...
#ifndef ITEX_CORE_COMPILER_XLA_PJRT_TRACKED_DEVICE_BUFFER_H_
#define ITEX_CORE_COMPILER_XLA_PJRT_TRACKED_DEVICE_BUFFER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_PJRT_TRACKED_DEVICE_BUFFER_H_
