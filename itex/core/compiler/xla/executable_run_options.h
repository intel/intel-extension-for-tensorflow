...
#ifndef ITEX_CORE_COMPILER_XLA_EXECUTABLE_RUN_OPTIONS_H_
#define ITEX_CORE_COMPILER_XLA_EXECUTABLE_RUN_OPTIONS_H_
...
class ExecutableRunOptions {
 public:
  ...
  // be null otherwise.  Routines that use this field should always ITEX_CHECK
  // (or TF_RET_CHECK) that it's not null before dereferencing it, so that users
  // get a clean crash rather than a segfault.
  //
...
#endif  // ITEX_CORE_COMPILER_XLA_EXECUTABLE_RUN_OPTIONS_H_
