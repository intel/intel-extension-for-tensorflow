...
#ifndef ITEX_CORE_COMPILER_XLA_ITERATOR_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_ITERATOR_UTIL_H_
...
// elements it returns.
//
// Together with itex::gtl::iterator_range, this lets classes which
// contain a collection of smart pointers expose a view of raw pointers to
// consumers.  For example:
//
//  class MyContainer {
//   public:
//    itex::gtl::iterator_range<
...
#endif  // ITEX_CORE_COMPILER_XLA_ITERATOR_UTIL_H_
