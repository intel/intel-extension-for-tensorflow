...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_OPTIMIZATION_BARRIER_EXPANDER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_OPTIMIZATION_BARRIER_EXPANDER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_OPTIMIZATION_BARRIER_EXPANDER_H_
