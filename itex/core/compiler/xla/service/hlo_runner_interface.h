...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_RUNNER_INTERFACE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_RUNNER_INTERFACE_H_
...
class HloRunnerInterface {
 public:
  ...
  struct ReplicatedExecuteOptions {
    ...
    // Otherwise, executes using itex_xla::Executable::ExecuteOnStreams.
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_RUNNER_INTERFACE_H_
