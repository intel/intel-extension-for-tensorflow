...
std::vector<std::unique_ptr<itex::protobuf::Message>>
...
std::unique_ptr<itex::protobuf::Message> Compiler::ComputeDefaultBackendConfig(
...
/* static */ void Compiler::RegisterCompilerFactory(
  ...
  ITEX_CHECK(factories->find(platform_id) == factories->end())
