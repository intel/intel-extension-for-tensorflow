...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_CALL_GRAPH_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_CALL_GRAPH_H_
...
class CallSite {
 public:
  CallSite(HloInstruction* instruction,
           ...
           CallContext context)
      : instruction_(ITEX_CHECK_NOTNULL(instruction)),
...
class CallGraph {
 ...
 private:
  explicit CallGraph(const HloModule* module);
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_CALL_GRAPH_H_
