...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_SPMD_SPMD_PARTITIONER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_SPMD_SPMD_PARTITIONER_H_
...
class SpmdPartitioningVisitor : public DfsHloVisitorWithDefault {
 public:
  ...
  PartitionedHlo& GetPartitionedHlo(const HloInstruction* hlo) {
    ITEX_CHECK_EQ(partitioned_instructions_.count(hlo), 1);
  ...
  void SetPartitionedHlo(const HloInstruction* hlo,
    ...
    ITEX_CHECK_EQ(partitioned_instructions_.count(hlo), 0);
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_SPMD_SPMD_PARTITIONER_H_
