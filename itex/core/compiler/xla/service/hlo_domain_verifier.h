...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_DOMAIN_VERIFIER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_DOMAIN_VERIFIER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_DOMAIN_VERIFIER_H_
