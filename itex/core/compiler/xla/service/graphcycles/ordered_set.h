...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GRAPHCYCLES_ORDERED_SET_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GRAPHCYCLES_ORDERED_SET_H_
...
class OrderedSet {
 public:
  ...
  void Erase(T value) {
    ...
    ITEX_DCHECK(it != value_to_index_.end());
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GRAPHCYCLES_ORDERED_SET_H_
