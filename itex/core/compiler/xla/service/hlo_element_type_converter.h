...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_ELEMENT_TYPE_CONVERTER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_ELEMENT_TYPE_CONVERTER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_ELEMENT_TYPE_CONVERTER_H_
