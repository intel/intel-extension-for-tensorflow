...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_ELEMENTAL_IR_EMITTER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_ELEMENTAL_IR_EMITTER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_ELEMENTAL_IR_EMITTER_H_
