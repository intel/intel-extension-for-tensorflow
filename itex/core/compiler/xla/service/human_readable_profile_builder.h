...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HUMAN_READABLE_PROFILE_BUILDER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HUMAN_READABLE_PROFILE_BUILDER_H_
...
class HumanReadableProfileBuilder {
 public:
  explicit HumanReadableProfileBuilder(absl::string_view computation_name,
    ...
    ITEX_CHECK_GE(clock_rate_ghz, 1e-9);
  }
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HUMAN_READABLE_PROFILE_BUILDER_H_
