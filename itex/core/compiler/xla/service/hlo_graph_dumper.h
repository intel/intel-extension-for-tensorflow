...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_GRAPH_DUMPER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_GRAPH_DUMPER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_GRAPH_DUMPER_H_
