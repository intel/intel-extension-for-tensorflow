...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_DATAFLOW_ANALYSIS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_DATAFLOW_ANALYSIS_H_
...
#include "itex/core/compiler/xla/service/hlo_phi_graph.h"
...
class HloDataflowAnalysis {
 public:
  ...
  // shape index. ITEX_CHECKs if the value set does not contain a exactly one
  // value.
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_DATAFLOW_ANALYSIS_H_
