...
#include "itex/core/compiler/xla/service/human_readable_profile_builder.h"
...
#include "itex/core/compiler/xla/metric_table_report.h"
...
using itex::strings::HumanReadableElapsedTime;
...
std::string HumanReadableProfileBuilder::ToString() const {
  ...
  ITEX_VLOG(1) << "Total floating point ops: " << total_flops;
