...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GATHER_SCATTER_UTILS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GATHER_SCATTER_UTILS_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GATHER_SCATTER_UTILS_H_
