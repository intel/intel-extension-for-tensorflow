...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_CONFIG_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_CONFIG_H_
...
class HloModuleConfig {
 public:
  ...
  static void AssignProtoShardableValueUpdatePairs(
      itex::protobuf::RepeatedPtrField<ShardableValueUpdatePairProto>*
          proto_update_pairs,
  ...
  static void AssignStructShardableValueUpdatePairs(
      ...
      const itex::protobuf::RepeatedPtrField<ShardableValueUpdatePairProto>&
          pairs);
  ...
  const ComputationLayout& entry_computation_layout() const {
    ITEX_CHECK(entry_computation_layout_.has_value());
  ...
  void set_use_auto_spmd_partitioning(bool use_auto_spmd_partitioning) {
    ...
    if (use_auto_spmd_partitioning) {
      ...
      ITEX_LOG(WARNING) << "Warning: Using auto_spmd_partitioning. It is "
                           "experimental and may "
                           "contain bugs!";
      ITEX_LOG(INFO) << "Overwriting use_spmd_partitioning to true, because "
  ...
  const DeviceAssignment& static_device_assignment() const {
    ITEX_CHECK(static_device_assignment_.has_value());
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_CONFIG_H_
