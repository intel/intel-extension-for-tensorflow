...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_SCHEDULE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_SCHEDULE_H_
...
class HloInstructionSequence {
 public:
  ...
  void replace_instruction(HloInstruction* old_instruction,
    ...
    ITEX_CHECK(instruction_it != instruction_sequence_.end())
        << "Do not find instruction id " << old_instruction->unique_id();
    ITEX_CHECK(id_it != id_sequence_.end());
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_SCHEDULE_H_
