...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_BUFFER_VALUE_CONTAINERS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_BUFFER_VALUE_CONTAINERS_H_
...
using BufferValueCompactPointerSet =
    itex::gtl::CompactPointerSet<const BufferValue*>;
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_BUFFER_VALUE_CONTAINERS_H_
