...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_EXECUTION_PROFILE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_EXECUTION_PROFILE_H_
...
#include "itex/core/compiler/xla/service/hlo_profile_printer.h"
#include "itex/core/compiler/xla/types.h"
#include "protos/hlo_execution_profile_data.pb.h"
...
class HloProfileIndexMap {
 public:
  ...
  size_t GetProfileIndexFor(const std::string& key) const {
    return itex_xla::FindOrDie(extra_metric_to_profile_idx(), key);
  }
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_EXECUTION_PROFILE_H_
