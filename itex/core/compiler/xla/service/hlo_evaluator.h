...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_EVALUATOR_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_EVALUATOR_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_EVALUATOR_H_
