...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MATCHERS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MATCHERS_H_
...
#include "itex/core/compiler/xla/test.h"
...
//   namespace op = itex_xla::opcode_matchers;
//   EXPECT_THAT(instruction,
//               op::Add(op::Reshape(), op::Add(op::Reshape(), _)));
namespace opcode_matchers {
#define HLO_MATCHER(opcode)                                            \
  template <typename... M>                                             \
  ::testing::Matcher<const ::itex_xla::HloInstruction*> opcode(        \
      M... operands) {                                                 \
    return ::testing::MakeMatcher(new ::itex_xla::testing::HloMatcher( \
        ::itex_xla::HloOpcode::k##opcode, {operands...}));             \
  }
HLO_MATCHER(Abs);
HLO_MATCHER(Add);
...
#define HLO_MATCHER_VECTOR_OPERANDS(opcode)                              \
  template <>                                                            \
  inline ::testing::Matcher<const ::itex_xla::HloInstruction*> opcode(   \
      std::vector<::testing::Matcher<const HloInstruction*>> operands) { \
    return ::testing::MakeMatcher(new ::itex_xla::testing::HloMatcher(   \
        ::itex_xla::HloOpcode::k##opcode, operands));                    \
  }
...
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Parameter(
    int64_t parameter_number) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloParameterMatcher(parameter_number));
}
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Parameter() {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloMatcher(HloOpcode::kParameter, {}));
}

// Comparison matchers below do not require any additional arguments.
template <typename... M>
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Eq(M... operands) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloComparisonMatcher(
      ComparisonDirection::kEq, {operands...}));
}
template <typename... M>
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Ne(M... operands) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloComparisonMatcher(
      ComparisonDirection::kNe, {operands...}));
}
template <typename... M>
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Ge(M... operands) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloComparisonMatcher(
      ComparisonDirection::kGe, {operands...}));
}
template <typename... M>
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Gt(M... operands) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloComparisonMatcher(
      ComparisonDirection::kGt, {operands...}));
}
template <typename... M>
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Le(M... operands) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloComparisonMatcher(
      ComparisonDirection::kLe, {operands...}));
}
template <typename... M>
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Lt(M... operands) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloComparisonMatcher(
...
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> GetTupleElement(
    ::testing::Matcher<const HloInstruction*> operand, int64_t tuple_index) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloGetTupleElementMatcher(operand, tuple_index));
}
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> GetTupleElement(
    ::testing::Matcher<const HloInstruction*> operand) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloMatcher(
      HloOpcode::kGetTupleElement, {operand}));
}
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> GetTupleElement() {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloMatcher(HloOpcode::kGetTupleElement, {}));
}
...
template <typename... M>
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> CustomCall(
    ::testing::Matcher<std::string> call_target_matcher, M... operands) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloCustomCallMatcher(
...
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> CustomCall() {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloMatcher(HloOpcode::kCustomCall, {}));
}

// Verifies the shape or the shape and the layout of an HLO instruction against
// the provided shape object.
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Shape(
    const class Shape& shape) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloShapeMatcher(shape));
}
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Shape(
    absl::string_view shape) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloShapeMatcher(ParseShape(shape).ValueOrDie()));
}
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> ShapeWithLayout(
    const class Shape& shape) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloShapeAndLayoutMatcher(shape));
}
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> ShapeWithLayout(
    absl::string_view shape, bool minor_to_major_only = false) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloShapeAndLayoutMatcher(
          ParseShape(shape).ValueOrDie(), minor_to_major_only));
}

// Verifies the value of the HloSharing against the provided sharding object.
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Sharding(
    const HloSharding& sharding) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloShardingMatcher(sharding));
}
// Matcher for Sharding from sharding string
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Sharding(
    absl::string_view sharding) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloShardingMatcher(
      ParseSharding(sharding).ValueOrDie()));
}
// Verifies that no HloSharding is set for an HLO instruction.
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> NoSharding() {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloShardingMatcher(absl::nullopt));
}

inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Dot() {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloMatcher(::itex_xla::HloOpcode::kDot, {}));
}
...
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Dot(
  ...
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloMatcher(
      ::itex_xla::HloOpcode::kDot, {lhs_matcher, rhs_matcher}));
}
...
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Dot(
    ...
    int64_t lhs_contracting_dim, int64_t rhs_contracting_dim) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloDotWithContractingDimsMatcher(
...
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> AsyncCopy(
    int64_t to_space, int64_t from_space,
    ::testing::Matcher<const HloInstruction*> operand_matcher) {
  return ::testing::MakeMatcher(new ::itex_xla::testing::HloAsyncCopyMatcher(
      to_space, from_space, operand_matcher));
}

//  - Constant() matches any constant.
//  - Constant(V) matches a constant with the given value.
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Constant() {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloMatcher(HloOpcode::kConstant, {}));
}
inline ::testing::Matcher<const ::itex_xla::HloInstruction*> Constant(
    Literal value) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloConstantMatcher(std::move(value)));
}

inline ::testing::Matcher<const ::itex_xla::HloInstruction*> ReplicaGroups(
    std::vector<std::vector<int64_t>> replica_groups) {
  return ::testing::MakeMatcher(
      new ::itex_xla::testing::HloReplicaGroupsMatcher(
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MATCHERS_H_
