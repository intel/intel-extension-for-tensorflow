...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_REDUCE_SCATTER_COMBINER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_REDUCE_SCATTER_COMBINER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_REDUCE_SCATTER_COMBINER_H_
