...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_COMMAND_LINE_OPTIONS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_COMMAND_LINE_OPTIONS_H_
...
void InitializeLLVMCommandLineOptions(const T& options) {
  if (!options.empty()) {
    ...
    ITEX_VLOG(2) << "Passing argv to LLVM:";
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_COMMAND_LINE_OPTIONS_H_
