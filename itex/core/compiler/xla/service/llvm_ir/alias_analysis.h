...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_ALIAS_ANALYSIS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_ALIAS_ANALYSIS_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_ALIAS_ANALYSIS_H_
