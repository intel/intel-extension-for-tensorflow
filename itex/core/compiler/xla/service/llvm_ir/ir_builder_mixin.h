...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_IR_BUILDER_MIXIN_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_IR_BUILDER_MIXIN_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_IR_BUILDER_MIXIN_H_
