...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_TUPLE_OPS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_TUPLE_OPS_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_TUPLE_OPS_H_
