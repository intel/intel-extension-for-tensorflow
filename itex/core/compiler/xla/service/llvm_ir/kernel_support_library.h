...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_KERNEL_SUPPORT_LIBRARY_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_KERNEL_SUPPORT_LIBRARY_H_
 ...
 public:
  ...
  void If(absl::string_view name, llvm::Value* condition,
    ...
    if (false_block_generator != nullptr) {
      ...
      ITEX_CHECK_OK(IfWithStatus(name, condition, [&]() {
        true_block_generator();
        return Status::OK();
      }));
    }
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_KERNEL_SUPPORT_LIBRARY_H_
