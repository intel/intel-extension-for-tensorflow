...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_IR_ARRAY_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_IR_ARRAY_H_
  ...
  class Index {
   public:
    ...
    explicit Index(llvm::Type* index_ty) : index_type_(index_ty) {
      ITEX_CHECK(index_ty->isIntegerTy());
    }
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_IR_ARRAY_H_
