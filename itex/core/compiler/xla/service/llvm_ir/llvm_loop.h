...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_LOOP_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_LOOP_H_
...
class ForLoopNest {
 public:
  ...
  std::unique_ptr<ForLoop> AddLoop(
      ...
      UnrollMode unroll_mode = itex_xla::llvm_ir::UnrollMode::kDefaultUnroll,
      bool prevent_vectorization = false);
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_LOOP_H_
