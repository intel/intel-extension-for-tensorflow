...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_MAPPED_PTR_CONTAINER_SORTER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_MAPPED_PTR_CONTAINER_SORTER_H_
...
MappedPtrContainerSorter<PointedToTy>::ComputeNewIndices(
  ...
  ITEX_VLOG(5) << "Pre flatten unordered_container result:\n"
               << result.ToString();
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_MAPPED_PTR_CONTAINER_SORTER_H_
