...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_WHILE_LOOP_CONSTANT_SINKING_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_WHILE_LOOP_CONSTANT_SINKING_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_WHILE_LOOP_CONSTANT_SINKING_H_
