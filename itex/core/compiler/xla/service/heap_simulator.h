...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HEAP_SIMULATOR_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HEAP_SIMULATOR_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HEAP_SIMULATOR_H_
