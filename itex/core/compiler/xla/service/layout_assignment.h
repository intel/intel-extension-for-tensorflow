...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LAYOUT_ASSIGNMENT_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LAYOUT_ASSIGNMENT_H_
...
class ChannelLayoutConstraints {
 public:
  ...
  Shape LayoutShapeForChannel(Shape shape, int64_t channel_id) const {
    ...
    ITEX_CHECK(it != constraints_.end()) << "Channel " << channel_id;
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LAYOUT_ASSIGNMENT_H_
