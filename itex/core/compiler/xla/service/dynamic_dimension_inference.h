...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_DYNAMIC_DIMENSION_INFERENCE_H_
