...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_ALL_REDUCE_FOLDER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_ALL_REDUCE_FOLDER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_ALL_REDUCE_FOLDER_H_
