...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_FLATTEN_CALL_GRAPH_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_FLATTEN_CALL_GRAPH_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_FLATTEN_CALL_GRAPH_H_
