...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_SOURCE_MAP_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_SOURCE_MAP_UTIL_H_
#include <string>
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_SOURCE_MAP_UTIL_H_
