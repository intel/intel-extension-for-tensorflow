...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_BUFFER_VALUE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_BUFFER_VALUE_H_
...
class BufferValue {
 public:
  ...
  Color color() const {
    ITEX_CHECK_NE(color_, kInvalidColor)
  ...
  void set_color(Color color) {
    ITEX_CHECK_NE(color, kInvalidColor)
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_BUFFER_VALUE_H_
