...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_DUMP_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_DUMP_H_
...
void DumpStringToFileInDirOrStdout(absl::string_view filename,
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_DUMP_H_
