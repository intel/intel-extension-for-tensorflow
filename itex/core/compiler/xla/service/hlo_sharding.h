...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_SHARDING_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_SHARDING_H_
...
class HloSharding {
 public:
  ...
  // Retrieves the unique device or fails with a ITEX_CHECK.
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_SHARDING_H_
