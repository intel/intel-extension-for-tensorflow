...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_COMPILER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_COMPILER_H_
...
class Compiler {
 public:
  ...
  virtual std::vector<std::unique_ptr<itex::protobuf::Message>>
  ...
  // The stream executor is passed in to provide information about the hardware
  // that the backend configurations would be targeting.
  virtual std::unique_ptr<itex::protobuf::Message> ComputeDefaultBackendConfig(
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_COMPILER_H_
