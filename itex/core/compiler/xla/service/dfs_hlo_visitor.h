...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_DFS_HLO_VISITOR_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_DFS_HLO_VISITOR_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_DFS_HLO_VISITOR_H_
