...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_LOOP_SCHEDULE_LINEARIZER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_LOOP_SCHEDULE_LINEARIZER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_LOOP_SCHEDULE_LINEARIZER_H_
