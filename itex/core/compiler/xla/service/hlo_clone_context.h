...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_CLONE_CONTEXT_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_CLONE_CONTEXT_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_CLONE_CONTEXT_H_
