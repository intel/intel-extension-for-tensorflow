...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_BACKEND_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_BACKEND_H_
...
class Backend {
 public:
  ...
  itex::thread::ThreadPool* eigen_intra_op_thread_pool() const;
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_BACKEND_H_
