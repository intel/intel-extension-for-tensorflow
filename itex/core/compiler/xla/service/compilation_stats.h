...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_COMPILATION_STATS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_COMPILATION_STATS_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_COMPILATION_STATS_H_
