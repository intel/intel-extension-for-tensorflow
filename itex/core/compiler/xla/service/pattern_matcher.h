...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_PATTERN_MATCHER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_PATTERN_MATCHER_H_
...
bool MatchAndLogIfFailed(HloInstruction* instr, absl::string_view desc,
  ...
  std::stringstream os;
  ITEX_CHECK(!Match(instr, pattern, {/*capture=*/false, /*explain_os=*/&os}));
  ITEX_LOG(ERROR) << "Failed to match " << desc << ":\n" << os.str();
  return false;
}
...
class AllOfPattern {
 public:
  ...
  bool Match(const Item* item, MatchOption option) const {
    ...
    ITEX_DCHECK(matched || !option.capture);
    return matched;
  }
...
class LayoutPatternBaseImpl {
 public:
  bool Match(const ::itex_xla::Layout* layout, MatchOption option) const {
    if (layout == nullptr) {
...
class LayoutPatternEqualImpl {
 public:
  explicit constexpr LayoutPatternEqualImpl(const ::itex_xla::Layout* layout)
      : layout_(layout) {}
...
class LayoutPattern {
 private:
  ...
  auto AppendImpl(NewImpl new_impl) const {
    auto new_allof = AllOf<::itex_xla::Layout>(impl_, std::move(new_impl));
 ...
 public:
  ...
  // Returns true and captures the layout iff it matches the pattern.
  bool Match(::itex_xla::Layout* layout, MatchOption option) const {
    if (impl_.Match(layout, option)) {
      if (option.capture && matched_layout_) {
        *matched_layout_ = layout;
      }
  ...
  constexpr auto EqualTo(const ::itex_xla::Layout* layout) const {
...
inline constexpr auto Layout(
    const ::itex_xla::Layout** matched_layout = nullptr) {
  return detail::LayoutPattern<const ::itex_xla::Layout,
...
// Creates a layout pattern that will capture the matched layout in the
// argument.
inline constexpr auto Layout(::itex_xla::Layout** matched_layout) {
  return detail::LayoutPattern<::itex_xla::Layout,
                               detail::LayoutPatternBaseImpl>(
      detail::LayoutPatternBaseImpl(), matched_layout);
}
...
class ShapePatternBaseImpl {
 public:
  bool Match(const ::itex_xla::Shape* shape, MatchOption option) const {
    if (shape == nullptr) {
...
class ShapePatternEqualImpl {
 public:
  explicit constexpr ShapePatternEqualImpl(const ::itex_xla::Shape* shape)
      : shape_(shape) {}
...
class ShapePatternCompatibleImpl {
 public:
  explicit constexpr ShapePatternCompatibleImpl(const ::itex_xla::Shape* shape)
      : shape_(shape) {}
...
class ShapePatternIsScalarImpl {
 public:
  constexpr ShapePatternIsScalarImpl() {}
...
class ShapePatternIsArrayImpl {
 public:
  constexpr ShapePatternIsArrayImpl() {}
...
class ShapePatternIsDenseArrayImpl {
 public:
  constexpr ShapePatternIsDenseArrayImpl() {}
...
class ShapePatternIsTupleImpl {
 public:
  constexpr ShapePatternIsTupleImpl() {}
...
class ShapePatternEffectiveScalarImpl {
 public:
  constexpr ShapePatternEffectiveScalarImpl() {}
...
class ShapePatternLayoutImpl {
 public:
  ...
  bool Match(::itex_xla::Shape* shape, MatchOption option) const {
...
class ShapePatternSubshapeImpl {
 ...
 private:
  ::itex_xla::Shape* GetSubshape(::itex_xla::Shape* shape) const {
    return ShapeUtil::GetMutableSubshape(shape, index_);
  }
  const ::itex_xla::Shape* GetSubshape(const ::itex_xla::Shape* shape) const {
...
class ShapePattern {
 private:
  template <typename NewImpl>
  auto AppendImpl(NewImpl new_impl) const {
    auto new_all_of = AllOf<::itex_xla::Shape>(impl_, std::move(new_impl));
 ...
 public:
  ...
  // The layout must outlive the returned pattern.
  constexpr auto EqualTo(const ::itex_xla::Shape* shape) const {
  ...
  constexpr auto CompatibleTo(const ::itex_xla::Shape* shape) const {
  ...
  constexpr auto WithLayoutEqualTo(const ::itex_xla::Layout* layout) const {
  ...
  ShapePattern<
      ShapeType,
      AllOfPattern<::itex_xla::Shape, Impl,
                   ShapePatternSubshapeImpl<
                       const ::itex_xla::Shape,
                       AllOfPattern<::itex_xla::Shape, ShapePatternBaseImpl,
                                    ShapePatternEqualImpl>>>>
  WithSubshapeEqualTo(ShapeIndexView index,
                      const ::itex_xla::Shape* shape) const {
    return WithSubshape(
        index, ShapePattern<const ::itex_xla::Shape, ShapePatternBaseImpl>(
...
inline constexpr auto Shape(const ::itex_xla::Shape** matched_shape = nullptr) {
  return detail::ShapePattern<const ::itex_xla::Shape,
                              detail::ShapePatternBaseImpl>(
      detail::ShapePatternBaseImpl(), matched_shape);
}

// Creates a shape pattern that will capture the matched layout in the argument.
inline constexpr auto Shape(::itex_xla::Shape** matched_shape) {
  return detail::ShapePattern<::itex_xla::Shape, detail::ShapePatternBaseImpl>(
      detail::ShapePatternBaseImpl(), matched_shape);
}
...
class HloInstructionPatternBaseImpl {
 public:
  bool Match(const ::itex_xla::HloInstruction* inst, MatchOption option) const {
    if (inst == nullptr) {
...
class HloInstructionPatternOptionalUnaryOpImpl {
 public:
  ...
  bool Match(::itex_xla::HloInstruction* inst, MatchOption option) const {
  ...
  bool MatchImpl(HloInstructionType* inst, MatchOption option) const {
    ...
    for (int i = 0; !wrote_explanation && i < 2; ++i) {
      if (matches[/*matcher*/ 0][/*operand*/ i] &&
        ...
        ITEX_CHECK(!matches[0][(i + 1) % 2]);
        ITEX_CHECK(!matches[1][(i + 1) % 2]);
        ITEX_CHECK(!wrote_explanation);
...
class HloInstructionPatternFusionKindImpl {
 public:
  explicit constexpr HloInstructionPatternFusionKindImpl(
      ::itex_xla::HloInstruction::FusionKind kind)
      : kind_(kind) {}
 ...
 private:
  ...
  ::itex_xla::HloInstruction::FusionKind kind_;
};
...
class HloInstructionPattern {
 private:
  ...
  auto AppendImpl(NewImpl new_impl) const {
    auto new_allof =
        AllOf<::itex_xla::HloInstruction>(impl_, std::move(new_impl));
 ...
 public:
  ...
  // Returns true and captures the instruction iff it matches the pattern.
  bool Match(::itex_xla::HloInstruction* inst, MatchOption option,
  ...
  constexpr auto WithShapeEqualTo(const ::itex_xla::Shape* shape) const {
  ...
  // recursion bug.
  template <typename Dummy = void>
  constexpr auto WithShapeCompatibleTo(const ::itex_xla::Shape* shape) const {
...
inline constexpr auto Op(
    const ::itex_xla::HloInstruction** matched_inst = nullptr) {
  return detail::HloInstructionPattern<const ::itex_xla::HloInstruction,
...
// Creates an instruction pattern that will capture the matched instruction in
// the argument.
inline constexpr auto Op(::itex_xla::HloInstruction** matched_inst) {
  return detail::HloInstructionPattern<::itex_xla::HloInstruction,
                                       detail::HloInstructionPatternBaseImpl>(
      detail::HloInstructionPatternBaseImpl(), matched_inst);
}
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_PATTERN_MATCHER_H_
