...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_ALGEBRAIC_SIMPLIFIER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_ALGEBRAIC_SIMPLIFIER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_ALGEBRAIC_SIMPLIFIER_H_
