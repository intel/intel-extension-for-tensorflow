...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_CONSTANT_FOLDING_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_CONSTANT_FOLDING_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_CONSTANT_FOLDING_H_
