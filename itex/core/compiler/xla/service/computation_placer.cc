...
/* static */ void ComputationPlacer::RegisterComputationPlacer(
  ...
  ITEX_CHECK(computation_placers->find(platform_id) ==
             computation_placers->end());
...
static std::unique_ptr<itex_xla::ComputationPlacer> CreateComputationPlacer() {
  return std::make_unique<itex_xla::ComputationPlacer>();
}

static bool InitModule() {
  itex_xla::ComputationPlacer::RegisterComputationPlacer(
      stream_executor::host::kHostPlatformId, &CreateComputationPlacer);
  itex_xla::ComputationPlacer::RegisterComputationPlacer(
      stream_executor::gpu::kSyclPlatformId, &CreateComputationPlacer);
  return true;
}
