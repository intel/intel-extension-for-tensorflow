...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_REACHABILITY_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_REACHABILITY_H_
...
class HloReachabilityMap {
 ...
 private:
  ...
  // fast bitwise OR operation not available in itex::gtl::BitMap.
  class BitVector {
   public:
    BitVector() = default;
    ...
    bool Get(size_t index) const {
      ITEX_DCHECK(index >= 0 && index < size_);
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_REACHABILITY_H_
