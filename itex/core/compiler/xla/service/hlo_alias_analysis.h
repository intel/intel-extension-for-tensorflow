...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_ALIAS_ANALYSIS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_ALIAS_ANALYSIS_H_
...
class HloAliasAnalysis {
 public:
  ...
  // Returns the unique buffer at the given position. ITEX_CHECK fails if the
  // buffer set at that position does not contain exactly one buffer.
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_ALIAS_ANALYSIS_H_
