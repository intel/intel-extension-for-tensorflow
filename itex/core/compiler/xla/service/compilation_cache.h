...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_COMPILATION_CACHE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_COMPILATION_CACHE_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_COMPILATION_CACHE_H_
