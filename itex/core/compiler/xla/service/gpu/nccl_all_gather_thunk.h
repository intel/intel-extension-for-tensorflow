...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_NCCL_ALL_GATHER_THUNK_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_NCCL_ALL_GATHER_THUNK_H_
#include <vector>
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_NCCL_ALL_GATHER_THUNK_H_
