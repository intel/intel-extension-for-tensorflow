...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_STREAM_EXECUTOR_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_STREAM_EXECUTOR_UTIL_H_
...
enum DataLayout {
  kYXDepthBatch = 0,
  kYXBatchDepth = 1,
  kBatchYXDepth = 2,    // NHWC
  kBatchDepthYX = 3,    // NCHW
  kBatchDepthYX4 = 4,   // NCHW_VECT_C 4-elem vectors
  kBatchDepthYX32 = 5,  // NCHW_VECT_C 32-elem vectors
};
...
StatusOr<itex::AutotuneResult> PickBestResult(
    absl::Span<itex::AutotuneResult const> profile_results,
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_STREAM_EXECUTOR_UTIL_H_
