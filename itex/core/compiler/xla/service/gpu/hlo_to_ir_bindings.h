...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_HLO_TO_IR_BINDINGS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_HLO_TO_IR_BINDINGS_H_
...
class HloToIrBindings {
 public:
  ...
  llvm::Value* GetBasePointer(const HloInstruction& hlo,
    ...
    ITEX_CHECK(it != base_ptrs_.end()) << hlo.ToString();
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_HLO_TO_IR_BINDINGS_H_
