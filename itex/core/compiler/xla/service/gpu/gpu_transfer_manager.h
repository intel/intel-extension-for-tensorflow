...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_TRANSFER_MANAGER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_TRANSFER_MANAGER_H_
...
class GpuTransferManager : public GenericTransferManager {
 public:
  ...
  Status TransferLiteralFromOutfeed(stream_executor::StreamExecutor* executor,
  ...
  static GpuTransferManager* CreateDPCPPTransferManager();
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_TRANSFER_MANAGER_H_
