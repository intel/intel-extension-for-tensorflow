...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_XLA_EXECUTOR_STATE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_XLA_EXECUTOR_STATE_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_XLA_EXECUTOR_STATE_H_
