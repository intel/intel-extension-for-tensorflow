...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_HLO_SCHEDULE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_HLO_SCHEDULE_H_
...
// launch order. This class differs from itex_xla::HloSchedule in that
// HloSchedule represents a total order of all instructions in the module for
// backends which execute HLO instructions strictly sequentially.
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_HLO_SCHEDULE_H_
