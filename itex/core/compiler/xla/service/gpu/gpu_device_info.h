...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_DEVICE_INFO_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_DEVICE_INFO_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_DEVICE_INFO_H_
