...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_SCATTER_EXPANDER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_SCATTER_EXPANDER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_SCATTER_EXPANDER_H_
