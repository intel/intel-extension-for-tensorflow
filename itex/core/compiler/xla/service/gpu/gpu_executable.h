...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_EXECUTABLE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_EXECUTABLE_H_
...
class GpuExecutable : public Executable {
 ...
 public:
  ...
  StatusOr<ExecutionOutput> ExecuteAsyncOnStream(
      ...
      HloExecutionProfile* hlo_execution_profile = nullptr) override;
  /*
 ...
 private:
  ...
  GpuExecutable(std::shared_ptr<HloModule> hlo_module,
                itex_xla::EntryFunctionAttributes entry_func_attrs,
  ...
  itex_xla::EntryFunctionAttributes entry_func_attrs_;

  std::string module_name_;

  itex_xla::Shape output_shape_;
  ...
  std::map<se::StreamExecutor*, se::ScopedModuleHandle> module_handles_
      ABSL_GUARDED_BY(module_handle_mutex_);
  // Cache of constant buffer allocation maps used by `ResolveConstantGlobals`.
  std::map<se::StreamExecutor*, BufferAllocToDeviceMemoryMap> module_globals_
      ABSL_GUARDED_BY(module_handle_mutex_);
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_GPU_EXECUTABLE_H_
