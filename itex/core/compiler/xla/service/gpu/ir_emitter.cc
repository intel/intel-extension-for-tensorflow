...
#include "itex/core/compiler/xla/service/gpu/ir_emitter.h"
...
#include "itex/core/compiler/xla/service/gpu/elemental_ir_emitter.h"
#include "itex/core/compiler/xla/service/gpu/ir_emitter_nested.h"
...
#include "itex/core/compiler/xla/service/llvm_ir/llvm_loop.h"
...
Status IrEmitter::HandleAddDependency(HloInstruction* add_dependency) {
  ITEX_VLOG(2) << "HandleAddDependency: " << add_dependency->ToString();
...
Status IrEmitter::HandleGetTupleElement(HloInstruction* get_tuple_element) {
  ...
  ITEX_CHECK(bindings_.BoundToIrValue(*operand));
...
bool IrEmitter::MaybeEmitDirectAtomicOperation(
  ...
  ITEX_CHECK_EQ(2, computation.num_parameters());
  ...
  if (root_opcode == HloOpcode::kAdd) {
    ...
    if (target_triple.isNVPTX()) {
      ...
      bool f64_atomic_add_supported = true;
...
#else
  auto* F32_IR =
      llvm::Type::getFloatTy(b_.GetInsertBlock()->getModule()->getContext());
  auto* F64_IR =
      llvm::Type::getDoubleTy(b_.GetInsertBlock()->getModule()->getContext());
  auto* I32_IR =
      llvm::Type::getInt32Ty(b_.GetInsertBlock()->getModule()->getContext());
  auto* I64_IR =
      llvm::Type::getInt64Ty(b_.GetInsertBlock()->getModule()->getContext());
  auto* F32_PTR_IR =
      llvm::Type::getFloatPtrTy(b_.GetInsertBlock()->getModule()->getContext());
  auto* F64_PTR_IR = llvm::Type::getDoublePtrTy(
      b_.GetInsertBlock()->getModule()->getContext());
  auto* I32_PTR_IR =
      llvm::Type::getInt32PtrTy(b_.GetInsertBlock()->getModule()->getContext());
  auto* I64_PTR_IR =
      llvm::Type::getInt64PtrTy(b_.GetInsertBlock()->getModule()->getContext());
  ...
  if (element_type == F32) {
    switch (root_opcode) {
      case HloOpcode::kAdd:
        name =
            "_Z21__spirv_AtomicFAddEXTPU3AS1fN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEf";
        break;
      case HloOpcode::kMaximum:
        name =
            "_Z21__spirv_AtomicFMaxEXTPU3AS1fN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEf";
        break;
      case HloOpcode::kMinimum:
        name =
            "_Z21__spirv_AtomicFMinEXTPU3AS1fN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEf";
        break;
    }
    if (name != "") {
      gpu::EmitDeviceFunctionCall(
          name,
          {output_address, b_.getInt32(1),
           b_.getInt32(912) /*memory_order::seq_cst*/, source},
          {F32_PTR_IR, I32_IR, I32_IR, F32_IR}, F32_IR,
          {llvm::Attribute::NoUnwind}, &b_);
      return true;
    }
  }
  if (element_type == F64) {
    switch (root_opcode) {
      case HloOpcode::kAdd:
        name =
            "_Z21__spirv_AtomicFAddEXTPU3AS1dN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEd";
        break;
      case HloOpcode::kMaximum:
        name =
            "_Z21__spirv_AtomicFMaxEXTPU3AS1dN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEd";
        break;
      case HloOpcode::kMinimum:
        name =
            "_Z21__spirv_AtomicFMinEXTPU3AS1dN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEd";
        break;
    }
    if (name != "") {
      gpu::EmitDeviceFunctionCall(
          ...
          {output_address, b_.getInt32(1),
           b_.getInt32(912) /*memory_order::seq_cst*/, source},
          {F64_PTR_IR, I32_IR, I32_IR, F64_IR}, F64_IR,
          {llvm::Attribute::NoUnwind}, &b_);
      return true;
    }
  }
  if (element_type == S32) {
    switch (root_opcode) {
      case HloOpcode::kAdd:
        name =
            "_Z18__spirv_AtomicIAddPU3AS1iN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEi";
        break;
      case HloOpcode::kMaximum:
        name =
            "_Z18__spirv_AtomicSMaxPU3AS1iN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEi";
        break;
      case HloOpcode::kMinimum:
        name =
            "_Z18__spirv_AtomicSMinPU3AS1iN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEi";
        break;
    }
    if (name != "") {
      gpu::EmitDeviceFunctionCall(
          ...
          {output_address, b_.getInt32(1),
           b_.getInt32(912) /*memory_order::seq_cst*/, source},
          {I32_PTR_IR, I32_IR, I32_IR, I32_IR}, I32_IR,
          {llvm::Attribute::NoUnwind}, &b_);
      return true;
    }
  }
  if (element_type == U32) {
    switch (root_opcode) {
      case HloOpcode::kAdd:
        name =
            "_Z18__spirv_AtomicIAddPU3AS1jN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEj";
        break;
      case HloOpcode::kMaximum:
        name =
            "_Z18__spirv_AtomicUMaxPU3AS1jN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEj";
        break;
      case HloOpcode::kMinimum:
        name =
            "_Z18__spirv_AtomicUMinPU3AS1jN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEj";
        break;
    }
    if (name != "") {
  ...
  if (element_type == S64) {
    switch (root_opcode) {
      case HloOpcode::kAdd:
        name =
            "_Z18__spirv_AtomicIAddPU3AS1lN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEl";
        break;
      case HloOpcode::kMaximum:
        name =
            "_Z18__spirv_AtomicSMaxPU3AS1lN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEl";
        break;
      case HloOpcode::kMinimum:
        name =
            "_Z18__spirv_AtomicSMinPU3AS1lN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEl";
        break;
    }
    if (name != "") {
      gpu::EmitDeviceFunctionCall(
          ...
          {output_address, b_.getInt32(1),
           b_.getInt32(912) /*memory_order::seq_cst*/, source},
          {I64_PTR_IR, I32_IR, I32_IR, I64_IR}, I64_IR,
          {llvm::Attribute::NoUnwind}, &b_);
      return true;
    }
  }
  if (element_type == U64) {
    switch (root_opcode) {
      case HloOpcode::kAdd:
        name =
            "_Z18__spirv_AtomicIAddPU3AS1mN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEm";
        break;
      case HloOpcode::kMaximum:
        name =
            "_Z18__spirv_AtomicUMaxPU3AS1mN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEm";
        break;
      case HloOpcode::kMinimum:
        name =
            "_Z18__spirv_AtomicUMinPU3AS1mN5__spv5Scope4FlagENS1_"
            "19MemorySemanticsMask4FlagEm";
        break;
    }
    if (name != "") {
...
Status IrEmitter::EmitAtomicOperationUsingCAS(const HloComputation& computation,
  ...
  ITEX_CHECK_NE(output_address_type, nullptr);
  ITEX_CHECK(output_address_type->isOpaqueOrPointeeTypeMatches(element_type));
  ...
  if (element_size < 32) {
    ...
    ITEX_CHECK_EQ((element_size % sizeof(char)), 0);
...
void IrEmitter::EmitAMDGPUAtomicAdd(llvm::Value* output_address,
                                    llvm::Value* source) {
  ITEX_CHECK(IsEmittingForAMDGPU());
...
Status IrEmitter::HandleFusion(HloInstruction* fusion) {
  ...
  ITEX_CHECK_EQ(HloInstruction::FusionKind::kLoop, fusion->fusion_kind());
