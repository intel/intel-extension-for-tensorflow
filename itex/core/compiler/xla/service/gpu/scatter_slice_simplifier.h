...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_SCATTER_SLICE_SIMPLIFIER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_SCATTER_SLICE_SIMPLIFIER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_SCATTER_SLICE_SIMPLIFIER_H_
