...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_IR_EMITTER_UNNESTED_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_IR_EMITTER_UNNESTED_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_IR_EMITTER_UNNESTED_H_
