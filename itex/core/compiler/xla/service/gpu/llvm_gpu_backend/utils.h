...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_LLVM_GPU_BACKEND_UTILS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_LLVM_GPU_BACKEND_UTILS_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_LLVM_GPU_BACKEND_UTILS_H_
