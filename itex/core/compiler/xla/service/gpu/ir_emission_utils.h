...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_IR_EMISSION_UTILS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_IR_EMISSION_UTILS_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_IR_EMISSION_UTILS_H_
