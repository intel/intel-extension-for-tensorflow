...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GPU_ALL_REDUCE_BLUECONNECT_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GPU_ALL_REDUCE_BLUECONNECT_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GPU_ALL_REDUCE_BLUECONNECT_H_
