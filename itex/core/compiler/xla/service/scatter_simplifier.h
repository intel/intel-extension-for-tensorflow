...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_SCATTER_SIMPLIFIER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_SCATTER_SIMPLIFIER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_SCATTER_SIMPLIFIER_H_
