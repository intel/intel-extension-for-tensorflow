...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_COST_ANALYSIS_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_COST_ANALYSIS_H_
   ...
   public:
    Properties()
        : flops_(0),
          ...
          reserved0_(0),
          reserved1_(0) {
      ITEX_DCHECK_EQ(kOperand0UtilizationKey, GetOperandUtilizationKey(0, {}));
      ITEX_DCHECK_EQ(kOperand1UtilizationKey, GetOperandUtilizationKey(1, {}));
      ITEX_DCHECK_EQ(kOperand0BytesAccessedKey,
                     GetOperandBytesAccessedKey(0, {}));
      ITEX_DCHECK_EQ(kOperand1BytesAccessedKey,
                     GetOperandBytesAccessedKey(1, {}));
      ITEX_DCHECK_EQ(kOutputRootBytesAccessedKey,
                     GetOutputBytesAccessedKey({}));
    }
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_COST_ANALYSIS_H_
