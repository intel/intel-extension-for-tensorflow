...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_DFS_HLO_VISITOR_WITH_DEFAULT_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_DFS_HLO_VISITOR_WITH_DEFAULT_H_
...
class DfsHloRewriteVisitor : public DfsHloVisitorWithDefault {
 ...
 protected:
  ...
  Status ReplaceWithNewInstruction(
    ...
    ITEX_VLOG(3) << "Replacing instruction:";
    ITEX_VLOG(3) << "  old: " << old_instruction->ToString();
    ITEX_VLOG(3) << "  new: " << new_instruction->ToString();
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_DFS_HLO_VISITOR_WITH_DEFAULT_H_
