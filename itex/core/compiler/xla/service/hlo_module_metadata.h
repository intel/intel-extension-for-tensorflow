...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_METADATA_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_METADATA_H_
...
class HloModuleMetadata {
 public:
  explicit HloModuleMetadata(itex::Env* env) : env_(env) {}
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_METADATA_H_
