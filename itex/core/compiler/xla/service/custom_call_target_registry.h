...
==============================================================================*/
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_CUSTOM_CALL_TARGET_REGISTRY_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_CUSTOM_CALL_TARGET_REGISTRY_H_
...
#define XLA_REGISTER_CUSTOM_CALL_TARGET_WITH_SYM_HELPER(symbol, address,       \
                                                        platform, counter)     \
  static ::itex_xla::RegisterCustomCallTarget XLA_REGISTER_CUSTOM_CALL_CONCAT( \
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_CUSTOM_CALL_TARGET_REGISTRY_H_
