...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GATHER_EXPANDER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GATHER_EXPANDER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GATHER_EXPANDER_H_
