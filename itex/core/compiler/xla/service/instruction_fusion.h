...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_INSTRUCTION_FUSION_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_INSTRUCTION_FUSION_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_INSTRUCTION_FUSION_H_
