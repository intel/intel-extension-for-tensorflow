...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_PASS_PIPELINE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_PASS_PIPELINE_H_
...
class HloPassPipeline : public HloPassInterface {
 public:
  ...
  T& AddPass(Args&&... args) {
    ITEX_CHECK(!run_called_) << "AddPass cannot be called after Run";
 ...
 private:
  ...
  friend class ::itex_xla::PhaseOrderPipeline;
};

}  // namespace itex_xla

#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_PASS_PIPELINE_H_
