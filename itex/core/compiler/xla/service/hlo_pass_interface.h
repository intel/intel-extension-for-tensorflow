...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_PASS_INTERFACE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_PASS_INTERFACE_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_PASS_INTERFACE_H_
