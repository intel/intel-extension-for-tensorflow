...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_GROUP_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_GROUP_H_
...
class HloModuleGroup {
 public:
  ...
  static StatusOr<std::unique_ptr<HloModuleGroup>> CreatePtrFromProto(
      const HloModuleGroupProto& proto,
      absl::Span<const HloModuleConfig> module_configs);
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_HLO_MODULE_GROUP_H_
