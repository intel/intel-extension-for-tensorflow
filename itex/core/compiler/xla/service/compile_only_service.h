...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_COMPILE_ONLY_SERVICE_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_COMPILE_ONLY_SERVICE_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_COMPILE_ONLY_SERVICE_H_
