...
#ifndef ITEX_CORE_COMPILER_XLA_SERVICE_GENERIC_TRANSFER_MANAGER_H_
#define ITEX_CORE_COMPILER_XLA_SERVICE_GENERIC_TRANSFER_MANAGER_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_SERVICE_GENERIC_TRANSFER_MANAGER_H_
