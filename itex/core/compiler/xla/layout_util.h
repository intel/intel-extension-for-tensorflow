...
#ifndef ITEX_CORE_COMPILER_XLA_LAYOUT_UTIL_H_
#define ITEX_CORE_COMPILER_XLA_LAYOUT_UTIL_H_
...
class LayoutUtil {
 public:
  ...
  static itex_xla::DimLevelType GetDimLevelType(const Layout& layout,
                                                int64_t dim);
  ...
  static bool ValidateDimLevel(itex_xla::DimLevelType dim_level_type,
...
#endif  // ITEX_CORE_COMPILER_XLA_LAYOUT_UTIL_H_
