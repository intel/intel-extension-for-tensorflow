...
#ifndef ITEX_CORE_COMPILER_XLA_TEXT_LITERAL_READER_H_
#define ITEX_CORE_COMPILER_XLA_TEXT_LITERAL_READER_H_
...
class TextLiteralReader {
 ...
 private:
  ...
  explicit TextLiteralReader(itex::RandomAccessFile* file);
  ...
  std::unique_ptr<itex::RandomAccessFile> file_;
...
#endif  // ITEX_CORE_COMPILER_XLA_TEXT_LITERAL_READER_H_
