...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_PLATFORM_INITIALIZE_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_PLATFORM_INITIALIZE_H_

#undef REGISTER_MODULE_INITIALIZER
#undef DECLARE_MODULE_INITIALIZER
#undef REGISTER_MODULE_INITIALIZER_SEQUENCE
#include "itex/core/compiler/xla/stream_executor/platform/platform.h"
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_PLATFORM_INITIALIZE_H_
