...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_HOST_OR_DEVICE_SCALAR_H_
