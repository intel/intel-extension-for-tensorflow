...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_TEMPORARY_MEMORY_MANAGER_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_TEMPORARY_MEMORY_MANAGER_H_
...
#include "itex/core/compiler/xla/stream_executor/temporary_device_memory.h"
...
class TemporaryMemoryManager {
 ...
 private:
  ...
  port::StatusOr<std::unique_ptr<TemporaryDeviceMemoryBase>> AllocateArrayBase(
      uint64_t element_count, uint64_t element_size);
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_TEMPORARY_MEMORY_MANAGER_H_
