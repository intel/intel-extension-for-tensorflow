...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_HOST_HOST_PLATFORM_ID_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_HOST_HOST_PLATFORM_ID_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_HOST_HOST_PLATFORM_ID_H_
