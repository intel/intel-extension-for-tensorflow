...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATUS_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATUS_H_

#include "absl/strings/string_view.h"
#include "itex/core/compiler/xla/stream_executor/lib/error.h"  // IWYU pragma: export
...
using Status = itex::Status;  // TENSORFLOW_STATUS_OK

#define SE_CHECK_OK(val) ITEX_CHECK_OK(val)
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATUS_H_
