...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATIC_THREADLOCAL_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATIC_THREADLOCAL_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATIC_THREADLOCAL_H_
