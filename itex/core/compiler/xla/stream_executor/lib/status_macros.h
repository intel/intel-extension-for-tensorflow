...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATUS_MACROS_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATUS_MACROS_H_
#include <utility>
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_LIB_STATUS_MACROS_H_
