...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_MEMORY_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_MEMORY_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_MEMORY_H_
