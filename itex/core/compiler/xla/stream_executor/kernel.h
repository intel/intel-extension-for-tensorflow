...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_KERNEL_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_KERNEL_H_
...
class KernelArgsArray : public KernelArgsArrayBase {
 public:
  ...
  void add_argument(const T& arg) {
    ...
    ITEX_CHECK_EQ(reinterpret_cast<uintptr_t>(generic_arg_storage) % alignof(T),
                  0);
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_KERNEL_H_
