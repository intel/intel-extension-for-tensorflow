...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_OPTIONS_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_OPTIONS_H_
#include <map>
#include <string>
#include <vector>
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_OPTIONS_H_
