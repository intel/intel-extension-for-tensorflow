...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_PLUGIN_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_PLUGIN_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_PLUGIN_H_
