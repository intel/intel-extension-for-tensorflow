...
#ifndef ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_DESCRIPTION_H_
#define ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_DESCRIPTION_H_
...
#endif  // ITEX_CORE_COMPILER_XLA_STREAM_EXECUTOR_DEVICE_DESCRIPTION_H_
