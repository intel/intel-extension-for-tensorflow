...
StatusOr<FftType> ConvertFftType(llvm::StringRef type_string) {
  ...
  switch (*type) {
    ...
    case mlir::mhlo::FftType::IFFT:
      return itex_xla::FftType::IFFT;
    case mlir::mhlo::FftType::RFFT:
      return itex_xla::FftType::RFFT;
    case mlir::mhlo::FftType::IRFFT:
      return itex_xla::FftType::IRFFT;
    default:
...
StatusOr<itex_xla::CustomCallApiVersion> ConvertCustomCallApiVersion(
  ...
  switch (api_version) {
    case mlir::mhlo::CustomCallApiVersion::API_VERSION_UNSPECIFIED:
      return itex_xla::CustomCallApiVersion::API_VERSION_UNSPECIFIED;
    case mlir::mhlo::CustomCallApiVersion::API_VERSION_ORIGINAL:
      return itex_xla::CustomCallApiVersion::API_VERSION_ORIGINAL;
    case mlir::mhlo::CustomCallApiVersion::API_VERSION_STATUS_RETURNING:
      return itex_xla::CustomCallApiVersion::API_VERSION_STATUS_RETURNING;
    case mlir::mhlo::CustomCallApiVersion::API_VERSION_STATUS_RETURNING_UNIFIED:
      return itex_xla::CustomCallApiVersion::
