...
#ifndef ITEX_CORE_COMPILER_MLIR_XLA_HLO_FUNCTION_IMPORTER_H_
#define ITEX_CORE_COMPILER_MLIR_XLA_HLO_FUNCTION_IMPORTER_H_
...
class HloFunctionImporter {
 public:
  ...
  static Status ImportAsFunc(
      const itex_xla::HloComputation& computation, mlir::ModuleOp module,
  ...
  static Status ImportAsRegion(const itex_xla::HloComputation& computation,
 ...
 private:
  HloFunctionImporter(mlir::ModuleOp module,
                      std::unordered_map<const itex_xla::HloComputation*,
  ...
  itex::Status ImportAsRegion(const HloComputation& computation,
                              mlir::Region* region,
                              bool flatten_region_arg_tuple = false);
  ...
  itex::Status ImportInstructions(const HloComputation& computation,
                                  mlir::Block* block,
  ...
  StatusOr<mlir::Operation*> ImportInstructionWithLayout(
      const itex_xla::HloInstruction* instruction,
      const llvm::SmallVectorImpl<mlir::Value>& operands,
  ...
  StatusOr<mlir::RankedTensorType> ConvertTensorType(
  ...
  std::unordered_map<const itex_xla::HloInstruction*, mlir::Value>
      instruction_value_map_;
};

}  // namespace itex_xla

#endif  // ITEX_CORE_COMPILER_MLIR_XLA_HLO_FUNCTION_IMPORTER_H_
