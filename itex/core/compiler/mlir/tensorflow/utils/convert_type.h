...
#ifndef ITEX_CORE_COMPILER_MLIR_TENSORFLOW_UTILS_CONVERT_TYPE_H_
#define ITEX_CORE_COMPILER_MLIR_TENSORFLOW_UTILS_CONVERT_TYPE_H_
...
// Status ConvertDataType(DataType dtype, mlir::Builder builder, mlir::Type*
// type);
...
#endif  // ITEX_CORE_COMPILER_MLIR_TENSORFLOW_UTILS_CONVERT_TYPE_H_
