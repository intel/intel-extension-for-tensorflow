...
#ifndef ITEX_CORE_GRAPH_UTILS_GRAPH_VIEW_INTERNAL_H_
#define ITEX_CORE_GRAPH_UTILS_GRAPH_VIEW_INTERNAL_H_
...
#endif  // ITEX_CORE_GRAPH_UTILS_GRAPH_VIEW_INTERNAL_H_
