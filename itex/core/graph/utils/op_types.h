...
#ifndef ITEX_CORE_GRAPH_UTILS_OP_TYPES_H_
#define ITEX_CORE_GRAPH_UTILS_OP_TYPES_H_
...
bool IsTensorArrayCreateOp(const NodeDef& node);
bool IsTensorArrayGradOp(const NodeDef& node);
bool IsTensorArrayGradWithShapeOp(const NodeDef& node);
bool IsTensorArrayWriteOp(const NodeDef& node);
bool IsTensorArrayReadOp(const NodeDef& node);
bool IsTensorArrayPackOp(const NodeDef& node);
bool IsTensorArrayGatherOp(const NodeDef& node);
bool IsTensorArrayConcatOp(const NodeDef& node);
bool IsTensorArrayUnPackOp(const NodeDef& node);
bool IsTensorArrayScatterOp(const NodeDef& node);
bool IsTensorArraySplitOp(const NodeDef& node);
bool IsTensorArraySizeOp(const NodeDef& node);
bool IsTensorArrayCloseOp(const NodeDef& node);
...
#endif  // ITEX_CORE_GRAPH_UTILS_OP_TYPES_H_
