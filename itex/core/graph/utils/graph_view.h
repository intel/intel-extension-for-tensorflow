...
#ifndef ITEX_CORE_GRAPH_UTILS_GRAPH_VIEW_H_
#define ITEX_CORE_GRAPH_UTILS_GRAPH_VIEW_H_
...
#include "itex/core/graph/utils/graph_view_internal.h"
...
class MutableFaninView
 ...
 public:
  ...
  explicit MutableFaninView(MutableGraphView* graph_view, int node_index,
    ...
    ITEX_DCHECK(port_index < 0 || port_index == fanin_index);
  }
...
#endif  // ITEX_CORE_GRAPH_UTILS_GRAPH_VIEW_H_
