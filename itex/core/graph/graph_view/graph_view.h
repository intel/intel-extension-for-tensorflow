...
#ifndef ITEX_CORE_GRAPH_GRAPH_VIEW_GRAPH_VIEW_H_
#define ITEX_CORE_GRAPH_GRAPH_VIEW_GRAPH_VIEW_H_
...
class GraphViewInternal {
 ...
 protected:
  ...
  void AddUniqueNodeOrDie(NodeDefT* node) {
    ...
    ITEX_CHECK(st.ok()) << st.error_message();
  }
...
#endif  // ITEX_CORE_GRAPH_GRAPH_VIEW_GRAPH_VIEW_H_
