...
#ifndef ITEX_CORE_GRAPH_GRAPH_VIEW_MUTABLE_GRAPH_VIEW_H_
#define ITEX_CORE_GRAPH_GRAPH_VIEW_MUTABLE_GRAPH_VIEW_H_
...
#endif  // ITEX_CORE_GRAPH_GRAPH_VIEW_MUTABLE_GRAPH_VIEW_H__
