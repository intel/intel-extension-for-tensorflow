...
#ifndef ITEX_CORE_GRAPH_NATIVE_LAYOUT_NATIVE_LAYOUT_H_
#define ITEX_CORE_GRAPH_NATIVE_LAYOUT_NATIVE_LAYOUT_H_
...
#endif  // ITEX_CORE_GRAPH_NATIVE_LAYOUT_NATIVE_LAYOUT_H_
