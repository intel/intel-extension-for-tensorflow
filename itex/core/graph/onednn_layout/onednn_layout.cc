...
static const std::vector<RewriteInfo>* GetRewriteInfo() {
  static std::vector<RewriteInfo> rinfo{
      ...
      {"_ITEXConv2DBackpropFilterWithBias", "_OneDnnConv2DBackpropFilterWithBias",
       CopyAttrsAll, RewriteConv2DBackprop},
      {"Conv2DBackpropInput", "_OneDnnConv2DBackpropInput", CopyAttrsAll,
       RewriteConv2DBackprop},
      {"_ITEXConv2DBackpropInputWithSlice", "_OneDnnConv2DBackpropInputWithSlice",
       CopyAttrsAll, RewriteConv2DBackprop},
      ...
      {"_ITEXConv3DBackpropFilterWithBias", "_OneDnnConv3DBackpropFilterWithBias",
