...
#ifndef ITEX_CORE_UTILS_MATH_UTIL_H_
...
IntegralType MathUtil::CeilOrFloorOfRatio(IntegralType numerator,
                                          IntegralType denominator) {
  ITEX_DCHECK_NE(0, denominator) << "Division by zero is not supported.";
...
#endif  // ITEX_CORE_UTILS_MATH_UTIL_H_
