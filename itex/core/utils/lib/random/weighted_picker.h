...
#ifndef ITEX_CORE_UTILS_LIB_RANDOM_WEIGHTED_PICKER_H_
#define ITEX_CORE_UTILS_LIB_RANDOM_WEIGHTED_PICKER_H_
...
#endif  // ITEX_CORE_UTILS_LIB_RANDOM_WEIGHTED_PICKER_H_
