...
#ifndef ITEX_CORE_UTILS_BOUNDS_CHECK_H_
#define ITEX_CORE_UTILS_BOUNDS_CHECK_H_
...
EIGEN_ALWAYS_INLINE EIGEN_DEVICE_FUNC bool FastBoundsCheck(const Ta index,
  ...
  return ITEX_PREDICT_TRUE(static_cast<UIndex>(index) <
...
#endif  // ITEX_CORE_UTILS_BOUNDS_CHECK_H_
