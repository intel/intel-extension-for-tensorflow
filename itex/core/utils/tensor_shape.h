...
#ifndef ITEX_CORE_UTILS_TENSOR_SHAPE_H_
#define ITEX_CORE_UTILS_TENSOR_SHAPE_H_
...
class TensorShapeRep {
 ...
 protected:
  ...
  void set_data_type(DataType dt) {
    ...
    ITEX_DCHECK_LT(static_cast<uint32>(dt), 256u);
...
class TensorShape : public TensorShapeBase<TensorShape> {
 ...
 private:
  // These ITEX_CHECK fail to ease debugging.
  // REQUIRES: dims() == NDIMS
...
#endif  // ITEX_CORE_UTILS_TENSOR_SHAPE_H_
