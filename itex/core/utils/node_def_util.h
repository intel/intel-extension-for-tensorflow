...
#ifndef ITEX_CORE_UTILS_NODE_DEF_UTIL_H_
#define ITEX_CORE_UTILS_NODE_DEF_UTIL_H_
...
// Node objects are actually specified as itex::NodeDef protocol
...
#endif  // ITEX_CORE_UTILS_NODE_DEF_UTIL_H_
