...
#ifndef ITEX_CORE_UTILS_PLATFORM_TYPES_H_
#define ITEX_CORE_UTILS_PLATFORM_TYPES_H_
...
// Alias itex::string to std::string.
using std::string;
...
#endif  // ITEX_CORE_UTILS_PLATFORM_TYPES_H_
