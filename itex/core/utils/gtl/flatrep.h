...
#ifndef ITEX_CORE_UTILS_GTL_FLATREP_H_
#define ITEX_CORE_UTILS_GTL_FLATREP_H_
 ...
 private:
  ...
  void Init(size_t N) {
    ...
    for (size_t i = 0; i < n; i++) {
      Bucket* b = &array[i];
      std::fill_n(b->marker, kWidth, kEmpty);
    }
...
#endif  // ITEX_CORE_UTILS_GTL_FLATREP_H_
