...
#ifndef ITEX_CORE_UTILS_GTL_INT_TYPE_H_
#define ITEX_CORE_UTILS_GTL_INT_TYPE_H_
...
#define ITEX_LIB_GTL_DEFINE_INT_TYPE(int_type_name, value_type) \
  struct int_type_name##_tag_ {};                               \
  typedef ::itex::gtl::IntType<int_type_name##_tag_, value_type> int_type_name;
...
#endif  // ITEX_CORE_UTILS_GTL_INT_TYPE_H_
