...
#ifndef ITEX_CORE_UTILS_COMMAND_LINE_FLAGS_H_
#define ITEX_CORE_UTILS_COMMAND_LINE_FLAGS_H_
...
// std::vector<itex::Flag> flag_list = {
...
//
// itex::port::InitMain(usage.c_str(), &argc, &argv);
...
class Flag {
 public:
  Flag(const char* name, int32* dst, const std::string& usage_text,
...
#endif  // ITEX_CORE_UTILS_COMMAND_LINE_FLAGS_H_
