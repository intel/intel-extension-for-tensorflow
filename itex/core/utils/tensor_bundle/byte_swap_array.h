...
#ifndef ITEX_CORE_UTILS_TENSOR_BUNDLE_BYTE_SWAP_ARRAY_H_
#define ITEX_CORE_UTILS_TENSOR_BUNDLE_BYTE_SWAP_ARRAY_H_
...
#define BYTE_SWAP_64(x)                                \
  ((uint64_t(htonl((x)&0x00000000ffffffffUL)) << 32) | \
   (htonl(((x)&0xffffffff00000000UL) >> 32)))  // NOLINT
...
#define BYTE_SWAP_32(x)                                   \
  ((((x)&0x000000ffU) << 24) | (((x)&0x0000ff00U) << 8) | \
   (((x)&0x00ff0000U) >> 8) | (((x)&0xff000000U) >> 24))  // NOLINT

#define BYTE_SWAP_64(x)                                                      \
  ((((x)&0x00000000000000ffUL) << 56) | (((x)&0x000000000000ff00UL) << 40) | \
   (((x)&0x0000000000ff0000UL) << 24) | (((x)&0x00000000ff000000UL) << 8) |  \//NOLINT
   (((x)&0x000000ff00000000UL) >> 8) | (((x)&0x0000ff0000000000UL) >> 24) |  \//NOLINT
   (((x)&0x00ff000000000000UL) >> 40) | (((x)&0xff00000000000000UL) >> 56)) //NOLINT
...
#endif  // ITEX_CORE_UTILS_TENSOR_BUNDLE_BYTE_SWAP_ARRAY_H_
