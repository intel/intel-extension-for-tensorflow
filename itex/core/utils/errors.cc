...
TF_Code ErrnoToCode(int err_number) {
  TF_Code code;
  switch (err_number) {
    case 0:
      code = TF_OK;
...
#endif
      code = TF_RESOURCE_EXHAUSTED;
      break;
    case EFBIG:      // File too large
    case EOVERFLOW:  // Value too large to be stored in data type
    case ERANGE:     // Result too large
      code = TF_OUT_OF_RANGE;
      break;
