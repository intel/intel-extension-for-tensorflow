...
#ifndef ITEX_CORE_UTILS_TYPE_TRAITS_H_
#define ITEX_CORE_UTILS_TYPE_TRAITS_H_
...
namespace std {
template <>
class numeric_limits<itex::qint8> : public numeric_limits<itex::int8> {};
template <>
class numeric_limits<itex::quint8> : public numeric_limits<itex::uint8> {};
template <>
class numeric_limits<itex::qint16> : public numeric_limits<itex::int16> {};
template <>
class numeric_limits<itex::quint16> : public numeric_limits<itex::uint16> {};
template <>
class numeric_limits<itex::qint32> : public numeric_limits<itex::int32> {};

// Specialize is_signed for quantized types.
template <>
struct is_signed<itex::qint8> : public is_signed<itex::int8> {};
template <>
struct is_signed<itex::quint8> : public is_signed<itex::uint8> {};
template <>
struct is_signed<itex::qint16> : public is_signed<itex::int16> {};
template <>
struct is_signed<itex::quint16> : public is_signed<itex::uint16> {};
template <>
struct is_signed<itex::qint32> : public is_signed<itex::int32> {};

}  // namespace std

#endif  // ITEX_CORE_UTILS_TYPE_TRAITS_H_
