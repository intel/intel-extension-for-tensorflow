...
//              DataTypeString(arg.type()), "'. Use 'Ref(type)' instead",
//              suffix);
//   }
//
//   return Status::OK();
...
//       }
//       if (warn) {
//         ITEX_LOG(WARNING) << "Op " << op_def.name() << " is deprecated."
...
//     const AttrMap& old_attrs, const AttrMap& new_attrs, std::vector<bool>*
//     ref, bool names) {
//   string s;
