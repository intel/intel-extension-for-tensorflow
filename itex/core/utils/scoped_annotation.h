...
#ifndef ITEX_CORE_UTILS_SCOPED_ANNOTATION_H_
...
#if !defined(IS_MOBILE_PLATFORM)
    if (ITEX_PREDICT_FALSE(AnnotationStack::IsEnabled())) {
...
#if !defined(IS_MOBILE_PLATFORM)
    if (ITEX_PREDICT_FALSE(old_length_ != kInvalidLength)) {
...
#endif  // ITEX_CORE_UTILS_SCOPED_ANNOTATION_H_
