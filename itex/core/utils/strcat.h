...
#ifndef ITEX_CORE_UTILS_STRCAT_H_
#define ITEX_CORE_UTILS_STRCAT_H_
...
class AlphaNum {
 public:
  ...
  AlphaNum(const itex::string& str) : piece_(str) {}

  AlphaNum(const itex::tstring& str)  // NOLINT(runtime/explicit)
      : piece_(str) {}
  // clang-format off
  template <typename A>
...
#endif  // ITEX_CORE_UTILS_STRCAT_H_
