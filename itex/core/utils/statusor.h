...
// value.
#ifndef ITEX_CORE_UTILS_STATUSOR_H_
#define ITEX_CORE_UTILS_STATUSOR_H_
...
#include "itex/core/utils/statusor_internals.h"
namespace itex {
...
template <typename T>
StatusOr<T>::StatusOr() : Base(Status(TF_UNKNOWN, "")) {}
