...
#ifndef ITEX_CORE_UTILS_ANNOTATION_STACK_H_
#define ITEX_CORE_UTILS_ANNOTATION_STACK_H_
...
extern std::atomic<int> g_annotation_enabled;
...
#endif  // ITEX_CORE_UTILS_ANNOTATION_STACK_H_
