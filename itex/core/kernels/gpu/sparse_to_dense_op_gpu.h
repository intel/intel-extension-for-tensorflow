...
#ifndef ITEX_CORE_KERNELS_GPU_SPARSE_TO_DENSE_OP_GPU_H_
#define ITEX_CORE_KERNELS_GPU_SPARSE_TO_DENSE_OP_GPU_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_SPARSE_TO_DENSE_OP_GPU_H_
