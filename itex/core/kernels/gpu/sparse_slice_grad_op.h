...
#ifndef ITEX_CORE_KERNELS_GPU_SPARSE_SLICE_GRAD_OP_H_
#define ITEX_CORE_KERNELS_GPU_SPARSE_SLICE_GRAD_OP_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_SPARSE_SLICE_GRAD_OP_H_
