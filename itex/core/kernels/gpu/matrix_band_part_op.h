...
#ifndef ITEX_CORE_KERNELS_GPU_MATRIX_BAND_PART_OP_H_
#define ITEX_CORE_KERNELS_GPU_MATRIX_BAND_PART_OP_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_MATRIX_BAND_PART_OP_H_
