...
#ifndef ITEX_CORE_KERNELS_GPU_GATHER_ND_OP_H_
#define ITEX_CORE_KERNELS_GPU_GATHER_ND_OP_H_
...
#define PARAMS_CASE(IXDIM)                                                    \
  case IXDIM: {                                                               \
    ...
    bad_i = func(c->eigen_gpu_device(), slice_size, params_flat, indices_mat, \
                 out_mat);                                                    \
  } break
      PARAMS_CASE(0);
      PARAMS_CASE(1);
...
#endif  // ITEX_CORE_KERNELS_GPU_GATHER_ND_OP_H_
