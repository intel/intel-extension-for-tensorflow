...
REGISTER5(UnaryOp, GPU, "Reciprocal", functor::inverse, float, Eigen::half,
          Eigen::bfloat16, itex::int64, complex64);
REGISTER3(SimpleBinaryOp, GPU, "ReciprocalGrad", functor::inverse_grad, float,
          Eigen::half, Eigen::bfloat16);
#ifdef ITEX_ENABLE_DOUBLE
REGISTER2(UnaryOp, GPU, "Reciprocal", functor::inverse, double, complex128);
REGISTER(SimpleBinaryOp, GPU, "ReciprocalGrad", functor::inverse_grad, double);
