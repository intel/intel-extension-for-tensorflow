...
#ifndef ITEX_CORE_KERNELS_GPU_EXTRACT_VOLUME_PATCHES_OP_H_
#define ITEX_CORE_KERNELS_GPU_EXTRACT_VOLUME_PATCHES_OP_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_EXTRACT_VOLUME_PATCHES_OP_H_
