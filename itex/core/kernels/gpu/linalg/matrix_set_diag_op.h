...
#ifndef ITEX_CORE_KERNELS_GPU_LINALG_MATRIX_SET_DIAG_OP_H_
#define ITEX_CORE_KERNELS_GPU_LINALG_MATRIX_SET_DIAG_OP_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_LINALG_MATRIX_SET_DIAG_OP_H_
