...
#ifndef ITEX_CORE_KERNELS_GPU_STRIDED_SLICE_OP_UTIL_H_
#define ITEX_CORE_KERNELS_GPU_STRIDED_SLICE_OP_UTIL_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_STRIDED_SLICE_OP_UTIL_H_
