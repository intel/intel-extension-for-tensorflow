...
#ifndef ITEX_CORE_KERNELS_GPU_IMAGE_ADJUST_CONTRAST_OP_H_
#define ITEX_CORE_KERNELS_GPU_IMAGE_ADJUST_CONTRAST_OP_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_IMAGE_ADJUST_CONTRAST_OP_H_
