...
#ifndef ITEX_CORE_KERNELS_GPU_CWISE_OP_CLIP_H_
#define ITEX_CORE_KERNELS_GPU_CWISE_OP_CLIP_H_
...
struct TernaryClipOp {
  void operator()(
      const Device& d, const typename TTypes<T>::ConstFlat& in0_flat,
      const typename TTypes<T>::ConstFlat& in1_flat,
      const typename TTypes<T>::ConstFlat& in2_flat,
...
#endif  // ITEX_CORE_KERNELS_GPU_CWISE_OP_CLIP_H_
