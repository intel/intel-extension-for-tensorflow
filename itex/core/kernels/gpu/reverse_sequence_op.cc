...
#define REGISTER_REVERSE_SEQUENCE_ITEX_GPU(type, len_type)       \
...
#define REGISTER_REVERSE_SEQUENCE_ITEX_GPU_LEN(type) \
  REGISTER_REVERSE_SEQUENCE_ITEX_GPU(type, int32);   \
  REGISTER_REVERSE_SEQUENCE_ITEX_GPU(type, int64);

TF_CALL_float(REGISTER_REVERSE_SEQUENCE_ITEX_GPU_LEN);
TF_CALL_half(REGISTER_REVERSE_SEQUENCE_ITEX_GPU_LEN);
TF_CALL_bfloat16(REGISTER_REVERSE_SEQUENCE_ITEX_GPU_LEN);
#ifdef ITEX_ENABLE_DOUBLE
TF_CALL_double(REGISTER_REVERSE_SEQUENCE_ITEX_GPU_LEN);
#endif  // ITEX_ENABLE_DOUBLE

#undef REGISTER_REVERSE_SEQUENCE_ITEX_GPU
#undef REGISTER_REVERSE_SEQUENCE_ITEX_GPU_LEN
