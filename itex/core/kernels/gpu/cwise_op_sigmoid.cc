...
REGISTER4(UnaryOp, GPU, "Sigmoid", functor::sigmoid, float, Eigen::half,
          Eigen::bfloat16, double);

REGISTER4(SimpleBinaryOp, GPU, "SigmoidGrad", functor::sigmoid_grad, float,
          Eigen::half, Eigen::bfloat16, double);
#else
