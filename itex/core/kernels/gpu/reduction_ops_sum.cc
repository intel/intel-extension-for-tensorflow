...
#define REGISTER_GPU_KERNELS_SUM(type)                                         \
...
TF_CALL_GPU_NUMBER_TYPES(REGISTER_GPU_KERNELS_SUM);
TF_CALL_int32(REGISTER_GPU_KERNELS_SUM);
TF_CALL_int64(REGISTER_GPU_KERNELS_SUM);

// TODO(itex): register complex64 and complex128 if the registration is
// supported
#ifdef ITEX_ENABLE_DOUBLE
TF_CALL_double(REGISTER_GPU_KERNELS_SUM);
#endif  // ITEX_ENABLE_DOUBLE

#undef REGISTER_GPU_KERNELS_SUM
}  // namespace itex
