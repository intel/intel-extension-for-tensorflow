...
#ifndef ITEX_CORE_KERNELS_GPU_RESIZE_NEAREST_NEIGHBOR_OP_H_
#define ITEX_CORE_KERNELS_GPU_RESIZE_NEAREST_NEIGHBOR_OP_H_
...
#endif  // ITEX_CORE_KERNELS_GPU_RESIZE_NEAREST_NEIGHBOR_OP_H_
