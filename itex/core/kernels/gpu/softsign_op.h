...
#ifndef ITEX_CORE_KERNELS_GPU_SOFTSIGN_OP_H_
#define ITEX_CORE_KERNELS_GPU_SOFTSIGN_OP_H_
// Functor definition for SoftsignOp and SoftsignGradOp
...
#endif  // ITEX_CORE_KERNELS_GPU_SOFTSIGN_OP_H_
