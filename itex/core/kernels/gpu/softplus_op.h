...
#ifndef ITEX_CORE_KERNELS_GPU_SOFTPLUS_OP_H_
#define ITEX_CORE_KERNELS_GPU_SOFTPLUS_OP_H_
// Functor definition for SoftplusOp and SoftplusGradOp
...
#endif  // ITEX_CORE_KERNELS_GPU_SOFTPLUS_OP_H_
