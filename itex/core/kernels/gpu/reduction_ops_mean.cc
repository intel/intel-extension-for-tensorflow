...
namespace itex {
#define REGISTER_GPU_KERNELS_MEAN(type)                                 \
...
TF_CALL_GPU_NUMBER_TYPES(REGISTER_GPU_KERNELS_MEAN);

// TODO(itex): register complex64 and complex128 if the registration is
// supported
#ifdef ITEX_ENABLE_DOUBLE
TF_CALL_double(REGISTER_GPU_KERNELS_MEAN);
#endif  // ITEX_ENABLE_DOUBLE

#undef REGISTER_GPU_KERNELS_MEAN
}  // namespace itex
