...
#ifndef ITEX_CORE_PROFILER_UTILS_XPLANE_SCHEMA_H_
#define ITEX_CORE_PROFILER_UTILS_XPLANE_SCHEMA_H_
#include <string>
...
extern const absl::string_view kHostThreadsPlaneName;
// Name prefix of XPlane that contains GPU events.
extern const absl::string_view kGpuPlanePrefix;
// Name prefix of XPlane that contains TPU events.
extern const absl::string_view kTpuPlanePrefix;
// Name prefix of XPlane that contains custom device events.
extern const absl::string_view kCustomPlanePrefix;
// Name prefix of XPlane that contains TPU runtime events.
extern const absl::string_view kTpuRuntimePlaneName;
// Name of XPlane that contains CUPTI driver API generated events.
extern const absl::string_view kCuptiDriverApiPlaneName;
// Name of XPlane that contains Roctracer API generated events.
extern const absl::string_view kRoctracerApiPlaneName;
// Name of XPlane that contains profile metadata such as XLA debug info.
extern const absl::string_view kMetadataPlaneName;
// Name of XPlane that contains kpi related metrics.
extern const absl::string_view kTFStreamzPlaneName;
// Name of XPlane that contains events from python tracer.
extern const absl::string_view kPythonTracerPlaneName;

// Names of XLines that contain ML-level events.
extern const absl::string_view kStepLineName;
extern const absl::string_view kTensorFlowNameScopeLineName;
extern const absl::string_view kTensorFlowOpLineName;
extern const absl::string_view kXlaModuleLineName;
extern const absl::string_view kXlaOpLineName;
extern const absl::string_view kKernelLaunchLineName;
extern const absl::string_view kSourceLineName;

// GPU device vendors.
extern const absl::string_view kDeviceVendorNvidia;
extern const absl::string_view kDeviceVendorAMD;
...
class XFlow {
 public:
  ...
  XFlow(uint64 flow_id, FlowDirection direction)
    ...
    ITEX_DCHECK_NE(Direction(), kFlowUnspecified);
  }
...
#endif  // ITEX_CORE_PROFILER_UTILS_XPLANE_SCHEMA_H_
