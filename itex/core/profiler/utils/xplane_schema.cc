...
#include "itex/core/profiler/utils/tf_op_utils.h"
...
const HostEventTypeMap& GetHostEventTypeMap() {
  static auto host_event_type_map = HostEventTypeMap({
  ...
  ITEX_DCHECK_EQ(host_event_type_map.size(), kNumHostEventTypes);
  return host_event_type_map;
}

const StatTypeMap& GetStatTypeMap() {
  static auto stat_type_map = StatTypeMap({
  ...
  ITEX_DCHECK_EQ(stat_type_map.size(), kNumStatTypes);
  return stat_type_map;
}

const HostEventTypeStrMap& GetHostEventTypeStrMap() {
  static auto host_event_type_str_map = HostEventTypeStrMap(
...
const StatTypeStrMap& GetStatTypeStrMap() {
  static auto stat_type_str_map =
      StatTypeStrMap(gtl::ReverseMap<StatTypeStrMap>(GetStatTypeMap()));
