...
#ifndef ITEX_CORE_PROFILER_UTILS_TIMESPAN_H_
#define ITEX_CORE_PROFILER_UTILS_TIMESPAN_H_
...
class Timespan {
 public:
  static Timespan FromEndPoints(uint64 begin_ps, uint64 end_ps) {
    ITEX_DCHECK_LE(begin_ps, end_ps);
...
#endif  // ITEX_CORE_PROFILER_UTILS_TIMESPAN_H_
