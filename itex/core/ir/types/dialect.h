...
#ifndef ITEX_CORE_IR_TYPES_DIALECT_H_
#define ITEX_CORE_IR_TYPES_DIALECT_H_
...
#include "itex/core/ir/types/dialect.h.inc"

// Include the Type classes declaration generated from types.td
#define GET_TYPEDEF_CLASSES
#include "itex/core/ir/types/types.h.inc"
 ...
 public:
  ...
  static TypeWithSubtypeStorage* construct(TypeStorageAllocator& allocator,
    ...
    return new (allocator.allocate<TypeWithSubtypeStorage>())
        TypeWithSubtypeStorage(subtypes);  // NOLINT
  }
...
#include "itex/core/ir/types/attributes.h.inc"
#include "itex/core/ir/types/attributes_enum.h.inc"

#endif  // ITEX_CORE_IR_TYPES_DIALECT_H_
