...
#ifndef ITEX_CORE_IR_TF_OP_WRAPPER_H_
#define ITEX_CORE_IR_TF_OP_WRAPPER_H_
...
class ControlRetIterator final
 ...
 public:
  ...
  Value mapElement(Value value) const {
    return value.getType().isa<itex_type::ControlType>()
               ? value
...
#endif  // ITEX_CORE_IR_TF_OP_WRAPPER_H_
